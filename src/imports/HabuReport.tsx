import svgPaths from "./svg-6dzrmcs5dj";

function Container2() {
  return <div className="absolute h-[1122.516px] left-0 top-0 w-[793.695px]" data-name="Container" style={{ backgroundImage: "linear-gradient(125.263deg, rgb(249, 250, 251) 0%, rgb(255, 255, 255) 50%, rgb(243, 244, 246) 100%)" }} />;
}

function Container3() {
  return <div className="absolute h-[1122.516px] left-0 opacity-3 top-0 w-[793.695px]" data-name="Container" />;
}

function Container5() {
  return <div className="absolute border-2 border-[#101828] border-solid left-0 rounded-[16777200px] size-[128px] top-0" data-name="Container" />;
}

function Container6() {
  return <div className="absolute border-2 border-[#101828] border-solid left-[8px] rounded-[16777200px] size-[112px] top-[8px]" data-name="Container" />;
}

function Container7() {
  return <div className="absolute border-2 border-[#101828] border-solid left-[16px] rounded-[16777200px] size-[96px] top-[16px]" data-name="Container" />;
}

function Container4() {
  return (
    <div className="absolute left-[633.7px] opacity-6 size-[128px] top-[32px]" data-name="Container">
      <Container5 />
      <Container6 />
      <Container7 />
    </div>
...
function Container8() {
  return (
    <div className="absolute left-[32px] opacity-6 size-[128px] top-[962.52px]" data-name="Container">
      <Container9 />
      <Container10 />
      <Container11 />
    </div>
...
function Container12() {
  return <div className="absolute bg-gradient-to-r from-[rgba(0,0,0,0)] h-[4px] left-0 opacity-20 to-[rgba(0,0,0,0)] top-0 via-1/2 via-[#99a1af] w-[793.695px]" data-name="Container" />;
}

function Container13() {
  return <div className="absolute bg-gradient-to-r from-[rgba(0,0,0,0)] h-[4px] left-0 opacity-20 to-[rgba(0,0,0,0)] top-[1118.52px] via-1/2 via-[#99a1af] w-[793.695px]" data-name="Container" />;
}

function Container1() {
  return (
    <div className="absolute h-[1122.516px] left-0 top-0 w-[793.695px]" data-name="Container">
      <Container2 />
      <Container3 />
      <Container4 />
      <Container8 />
...
function Container15() {
  return (
    <div className="absolute content-stretch flex h-[34px] items-start justify-end left-[75.59px] top-[52.91px] w-[642.523px]" data-name="Container">
      <Container16 />
    </div>
  );
}
...
function Container19() {
  return <div className="bg-gradient-to-r flex-[117.766_0_0] from-[rgba(0,0,0,0)] h-px min-h-px min-w-px to-[#d1d5dc]" data-name="Container" />;
}
...
function Container20() {
  return <div className="bg-gradient-to-l flex-[117.766_0_0] from-[rgba(0,0,0,0)] h-px min-h-px min-w-px to-[#d1d5dc]" data-name="Container" />;
}

function Container18() {
  return (
    <div className="absolute content-stretch flex gap-[16px] h-[16px] items-center left-[97.26px] pr-[-0.008px] top-[225.13px] w-[448px]" data-name="Container">
      <Container19 />
      <Text />
      <Container20 />
    </div>
...
function Container21() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[8px] h-[75.195px] items-start left-[190.52px] top-[273.13px] w-[261.484px]" data-name="Container">
      <Heading />
      <Container22 />
    </div>
  );
...
function Container23() {
  return <div className="absolute bg-gradient-to-r from-[rgba(0,0,0,0)] h-px left-[273.26px] to-[rgba(0,0,0,0)] top-[380.33px] via-1/2 via-[#99a1af] w-[96px]" data-name="Container" />;
}
...
function Container27() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[4px] h-[40.797px] items-start left-0 top-0 w-[207px]" data-name="Container">
      <Container28 />
      <Container29 />
    </div>
  );
...
function Container30() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[4px] h-[40.797px] items-start left-[239px] top-0 w-[207px]" data-name="Container">
      <Container31 />
      <Container32 />
    </div>
  );
...
function Container33() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[4px] h-[40.797px] items-start left-0 top-[64.8px] w-[207px]" data-name="Container">
      <Container34 />
      <Container35 />
    </div>
  );
...
function Container36() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[4px] h-[40.797px] items-start left-[239px] top-[64.8px] w-[207px]" data-name="Container">
      <Container37 />
      <Container38 />
    </div>
  );
...
function Container26() {
  return (
    <div className="h-[105.594px] relative shrink-0 w-full" data-name="Container">
      <Container27 />
      <Container30 />
      <Container33 />
      <Container36 />
...
function Container25() {
  return (
    <div className="absolute bg-[rgba(255,255,255,0.8)] content-stretch flex flex-col h-[171.594px] items-start left-0 pb-px pt-[33px] px-[33px] top-0 w-[512px]" data-name="Container">
...
function Container39() {
  return <div className="absolute border-[#d1d5dc] border-l-2 border-solid border-t-2 left-[-8px] size-[32px] top-[-8px]" data-name="Container" />;
}

function Container40() {
  return <div className="absolute border-[#d1d5dc] border-b-2 border-r-2 border-solid left-[488px] size-[32px] top-[147.59px]" data-name="Container" />;
}

function Container24() {
  return (
    <div className="absolute h-[171.594px] left-[65.26px] top-[461.33px] w-[512px]" data-name="Container">
      <Container25 />
      <Container39 />
      <Container40 />
    </div>
...
function Container17() {
  return (
    <div className="absolute h-[858.055px] left-[75.59px] top-[134.91px] w-[642.523px]" data-name="Container">
      <Container18 />
      <Container21 />
      <Container23 />
      <Container24 />
...
function Container42() {
  return <div className="absolute bg-[#d1d5dc] h-px left-[289.26px] top-0 w-[64px]" data-name="Container" />;
}
...
function Container41() {
  return (
    <div className="absolute h-[76.648px] left-[75.59px] top-[992.96px] w-[642.523px]" data-name="Container">
      <Container42 />
      <Paragraph />
      <Container43 />
    </div>
...
function TitlePage() {
  return (
    <div className="h-[1122.516px] overflow-clip relative shrink-0 w-full" data-name="TitlePage">
      <Container1 />
      <Container14 />
    </div>
  );
...
function Container46() {
  return <div className="absolute bg-[#d1d5dc] h-px left-0 top-[67.2px] w-[64px]" data-name="Container" />;
}

function Container44() {
  return (
    <div className="h-[68.195px] relative shrink-0 w-full" data-name="Container">
      <Container45 />
      <Heading1 />
      <Container46 />
    </div>
...
function TableRow() {
  return (
    <div className="absolute h-[41.594px] left-0 top-0 w-[640.523px]" data-name="Table Row">
      <HeaderCell />
      <HeaderCell1 />
    </div>
  );
...
function TableHeader() {
  return (
    <div className="absolute bg-[#f9fafb] h-[41.594px] left-0 top-0 w-[640.523px]" data-name="Table Header">
      <TableRow />
    </div>
  );
}
...
function TableRow1() {
  return (
    <div className="absolute bg-white border-[#e5e7eb] border-b border-solid h-[45.297px] left-0 top-0 w-[640.523px]" data-name="Table Row">
      <TableCell />
      <TableCell1 />
    </div>
  );
...
function TableRow2() {
  return (
    <div className="absolute bg-[rgba(249,250,251,0.5)] border-[#e5e7eb] border-b border-solid h-[45.797px] left-0 top-[45.3px] w-[640.523px]" data-name="Table Row">
      <TableCell2 />
      <TableCell3 />
    </div>
  );
...
function TableRow3() {
  return (
    <div className="absolute bg-white border-[#e5e7eb] border-b border-solid h-[45.797px] left-0 top-[91.09px] w-[640.523px]" data-name="Table Row">
      <TableCell4 />
      <TableCell5 />
    </div>
  );
...
function TableRow4() {
  return (
    <div className="absolute bg-[rgba(249,250,251,0.5)] h-[45.297px] left-0 top-[136.89px] w-[640.523px]" data-name="Table Row">
      <TableCell6 />
      <TableCell7 />
    </div>
  );
...
function TableBody() {
  return (
    <div className="absolute h-[182.188px] left-0 top-[41.59px] w-[640.523px]" data-name="Table Body">
      <TableRow1 />
      <TableRow2 />
      <TableRow3 />
      <TableRow4 />
...
function Table() {
  return (
    <div className="h-[223.781px] relative shrink-0 w-full" data-name="Table">
      <TableHeader />
      <TableBody />
    </div>
  );
...
function Container49() {
  return (
    <div className="h-[225.781px] relative rounded-[4px] shrink-0 w-full" data-name="Container">
...
function Container47() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] h-[262.578px] items-start relative shrink-0 w-full" data-name="Container">
      <Container48 />
      <Container49 />
    </div>
  );
...
function Container56() {
  return (
    <div className="h-[16px] relative shrink-0 w-full" data-name="Container">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[16px] left-0 not-italic text-[#007a55] text-[10px] top-0 tracking-[0.6172px] uppercase whitespace-nowrap">Strategy</p>
    </div>
  );
}
...
function Container55() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[4px] h-[45.594px] items-start left-0 top-0 w-[284.258px]" data-name="Container">
      <Container56 />
      <Container57 />
    </div>
  );
...
function Container59() {
  return (
    <div className="h-[16px] relative shrink-0 w-full" data-name="Container">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[16px] left-0 not-italic text-[#007a55] text-[10px] top-0 tracking-[0.6172px] uppercase whitespace-nowrap">Expected ROI</p>
    </div>
  );
}
...
function Container58() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[4px] h-[45.594px] items-start left-[308.26px] top-0 w-[284.266px]" data-name="Container">
      <Container59 />
      <Container60 />
    </div>
  );
...
function Container62() {
  return (
    <div className="h-[16px] relative shrink-0 w-full" data-name="Container">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[16px] left-0 not-italic text-[#007a55] text-[10px] top-0 tracking-[0.6172px] uppercase whitespace-nowrap">Timeline</p>
    </div>
  );
}
...
function Container61() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[4px] h-[45.594px] items-start left-0 top-[69.59px] w-[284.258px]" data-name="Container">
      <Container62 />
      <Container63 />
    </div>
  );
...
function Container65() {
  return (
    <div className="h-[16px] relative shrink-0 w-full" data-name="Container">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[16px] left-0 not-italic text-[#007a55] text-[10px] top-0 tracking-[0.6172px] uppercase whitespace-nowrap">Risk Level</p>
    </div>
  );
}
...
function Container64() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[4px] h-[45.594px] items-start left-[308.26px] top-[69.59px] w-[284.266px]" data-name="Container">
      <Container65 />
      <Container66 />
    </div>
  );
...
function Container54() {
  return (
    <div className="absolute h-[115.188px] left-[25px] top-[65px] w-[592.523px]" data-name="Container">
      <Container55 />
      <Container58 />
      <Container61 />
      <Container64 />
...
function Container52() {
  return (
    <div className="bg-[#ecfdf5] h-[221.188px] relative rounded-[8px] shrink-0 w-full" data-name="Container">
...
function Container50() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] h-[257.984px] items-start relative shrink-0 w-full" data-name="Container">
      <Container51 />
      <Container52 />
    </div>
  );
...
function Container69() {
  return (
    <div className="bg-[#f9fafb] h-[137.375px] relative shrink-0 w-full" data-name="Container">
      <div aria-hidden="true" className="absolute border-[#101828] border-l-4 border-solid inset-0 pointer-events-none" />
...
function Container67() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] h-[174.172px] items-start relative shrink-0 w-full" data-name="Container">
      <Container68 />
      <Container69 />
    </div>
  );
...
function ExecutiveSummary() {
  return (
    <div className="h-[964.742px] relative shrink-0 w-full" data-name="ExecutiveSummary">
      <div className="content-stretch flex flex-col gap-[32px] items-start pt-[52.906px] px-[75.586px] relative size-full">
        <Container44 />
        <Container47 />
        <Container50 />
        <Container67 />
...
function TableRow5() {
  return (
    <div className="absolute bg-white border-[#e5e7eb] border-b border-solid h-[42.094px] left-0 top-0 w-[640.523px]" data-name="Table Row">
      <TableCell8 />
      <TableCell9 />
    </div>
  );
...
function TableRow6() {
  return (
    <div className="absolute bg-[rgba(249,250,251,0.5)] border-[#e5e7eb] border-b border-solid h-[42.594px] left-0 top-[42.09px] w-[640.523px]" data-name="Table Row">
      <TableCell10 />
      <TableCell11 />
    </div>
  );
...
function TableRow7() {
  return (
    <div className="absolute bg-white border-[#e5e7eb] border-b border-solid h-[42.594px] left-0 top-[84.69px] w-[640.523px]" data-name="Table Row">
      <TableCell12 />
      <TableCell13 />
    </div>
  );
...
function TableRow8() {
  return (
    <div className="absolute bg-[rgba(249,250,251,0.5)] border-[#e5e7eb] border-b border-solid h-[42.594px] left-0 top-[127.28px] w-[640.523px]" data-name="Table Row">
      <TableCell14 />
      <TableCell15 />
    </div>
  );
...
function TableRow9() {
  return (
    <div className="absolute bg-white border-[#e5e7eb] border-b border-solid h-[42.594px] left-0 top-[169.88px] w-[640.523px]" data-name="Table Row">
      <TableCell16 />
      <TableCell17 />
    </div>
  );
...
function TableRow10() {
  return (
    <div className="absolute bg-[rgba(249,250,251,0.5)] border-[#e5e7eb] border-b border-solid h-[42.594px] left-0 top-[212.47px] w-[640.523px]" data-name="Table Row">
      <TableCell18 />
      <TableCell19 />
    </div>
  );
...
function TableRow11() {
  return (
    <div className="absolute bg-white border-[#e5e7eb] border-b border-solid h-[42.594px] left-0 top-[255.06px] w-[640.523px]" data-name="Table Row">
      <TableCell20 />
      <TableCell21 />
    </div>
  );
...
function TableRow12() {
  return (
    <div className="absolute bg-[rgba(249,250,251,0.5)] border-[#e5e7eb] border-b border-solid h-[42.594px] left-0 top-[297.66px] w-[640.523px]" data-name="Table Row">
      <TableCell22 />
      <TableCell23 />
    </div>
  );
...
function TableRow13() {
  return (
    <div className="absolute bg-white border-[#e5e7eb] border-b border-solid h-[42.594px] left-0 top-[340.25px] w-[640.523px]" data-name="Table Row">
      <TableCell24 />
      <TableCell25 />
    </div>
  );
...
function TableRow14() {
  return (
    <div className="absolute bg-[rgba(249,250,251,0.5)] h-[42.094px] left-0 top-[382.84px] w-[640.523px]" data-name="Table Row">
      <TableCell26 />
      <TableCell27 />
    </div>
  );
...
function TableBody1() {
  return (
    <div className="absolute h-[424.938px] left-0 top-0 w-[640.523px]" data-name="Table Body">
      <TableRow5 />
      <TableRow6 />
      <TableRow7 />
      <TableRow8 />
...
function Table1() {
  return (
    <div className="h-[424.938px] relative shrink-0 w-full" data-name="Table">
      <TableBody1 />
    </div>
  );
}
...
function Container74() {
  return (
    <div className="h-[426.938px] relative rounded-[4px] shrink-0 w-full" data-name="Container">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col items-start p-px relative size-full">
          <Table1 />
        </div>
  ...
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Icon">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_2927_1244)" id="Icon">
...
function Container78() {
  return (
    <div className="absolute content-stretch flex gap-[8px] h-[17.594px] items-center left-[16px] top-[12px] w-[395.016px]" data-name="Container">
      <Icon />
      <Text1 />
    </div>
  );
...
function Container79() {
  return (
    <div className="absolute content-stretch flex gap-[8px] h-[17.594px] items-center left-[16px] top-[12.5px] w-[395.016px]" data-name="Container">
      <Icon1 />
      <Text2 />
    </div>
  );
...
function TableRow20() {
  return (
    <div className="absolute bg-[rgba(249,250,251,0.5)] h-[42.094px] left-0 top-[212.47px] w-[640.523px]" data-name="Table Row">
      <TableCell38 />
      <TableCell39 />
    </div>
  );
...
function TableBody2() {
  return (
    <div className="absolute h-[254.563px] left-0 top-0 w-[640.523px]" data-name="Table Body">
      <TableRow15 />
      <TableRow16 />
      <TableRow17 />
      <TableRow18 />
...
function Table2() {
  return (
    <div className="h-[254.563px] relative shrink-0 w-full" data-name="Table">
      <TableBody2 />
    </div>
  );
}
...
function Container77() {
  return (
    <div className="h-[256.563px] relative rounded-[4px] shrink-0 w-full" data-name="Container">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col items-start p-px relative size-full">
          <Table2 />
        </div>
...
function Container84() {
  return (
    <div className="content-stretch flex gap-[12px] h-[27.594px] items-center relative shrink-0 w-full" data-name="Container">
      <Container85 />
      <Container86 />
    </div>
  );
...
function Container75() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] h-[336.953px] items-start relative shrink-0 w-full" data-name="Container">
      <Container76 />
      <Container77 />
      <Container84 />
    </div>
...
function Container73() {
  return (
    <div className="content-stretch flex flex-col gap-[32px] h-[795.891px] items-start relative shrink-0 w-full" data-name="Container">
      <Container74 />
      <Container75 />
    </div>
  );
...
function PropertyOverview() {
  return (
    <div className="h-[1001.898px] relative shrink-0 w-full" data-name="PropertyOverview">
      <div className="content-stretch flex flex-col gap-[32px] items-start pt-[52.906px] px-[75.586px] relative size-full">
        <Container70 />
        <Container73 />
      </div>
...
function TableRow24() {
  return (
    <div className="absolute bg-[rgba(249,250,251,0.5)] h-[42.094px] left-0 top-[127.28px] w-[640.523px]" data-name="Table Row">
      <TableCell46 />
      <TableCell47 />
    </div>
  );
...
function TableBody3() {
  return (
    <div className="absolute h-[169.375px] left-0 top-0 w-[640.523px]" data-name="Table Body">
      <TableRow21 />
      <TableRow22 />
      <TableRow23 />
      <TableRow24 />
...
function Table3() {
  return (
    <div className="h-[169.375px] relative shrink-0 w-full" data-name="Table">
      <TableBody3 />
    </div>
  );
}
...
function Container93() {
  return (
    <div className="absolute h-[171.375px] left-0 rounded-[4px] top-[36.8px] w-[642.523px]" data-name="Container">
...
function ListItem() {
  return (
    <div className="h-[21.594px] relative shrink-0 w-full" data-name="List Item">
      <Text7 />
      <Text8 />
    </div>
  );
...
function List() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] h-[110.375px] items-start relative shrink-0 w-full" data-name="List">
      <ListItem />
      <ListItem1 />
      <ListItem2 />
      <ListItem3 />
...
function Container94() {
  return (
    <div className="absolute bg-[#f9fafb] content-stretch flex flex-col gap-[12px] h-[187.969px] items-start left-0 pl-[28px] pr-[24px] pt-[24px] top-[232.17px] w-[642.523px]" data-name="Container">
      <div aria-hidden="true" className="absolute border-[#101828] border-l-4 border-solid inset-0 pointer-events-none" />
      <Container95 />
      <List />
    </div>
...
function Container91() {
  return (
    <div className="h-[420.141px] relative shrink-0 w-full" data-name="Container">
      <Container92 />
      <Container93 />
      <Container94 />
    </div>
...
function Container101() {
  return (
    <div className="absolute h-[51.188px] left-[25px] top-[102.59px] w-[592.523px]" data-name="Container">
      <Container102 />
      <Container103 />
      <Container104 />
      <Container105 />
...
function Container106() {
  return (
    <div className="absolute bg-[rgba(255,255,255,0.5)] h-[40px] left-[25px] rounded-[4px] top-[169.78px] w-[592.523px]" data-name="Container">
      <p className="absolute font-['Inter:Italic',sans-serif] font-normal italic leading-[16px] left-[12px] text-[#364153] text-[10px] top-[12px] tracking-[0.1172px] whitespace-nowrap">Metro connectivity historically drives 25-35% land appreciation in adjacent zones within 18 months of operation.</p>
    </div>
  );
}
...
function Container98() {
  return (
    <div className="bg-[#ecfdf5] h-[234.781px] relative rounded-[8px] shrink-0 w-full" data-name="Container">
      <div aria-hidden="true" className="absolute border border-[#a4f4cf] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <Container99 />
      <Container100 />
      <Container101 />
...
function Container107() {
  return (
    <div className="h-[171.375px] relative rounded-[4px] shrink-0 w-full" data-name="Container">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col items-start p-px relative size-full">
          <Table4 />
        </div>
...
function Container96() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] h-[458.953px] items-start relative shrink-0 w-full" data-name="Container">
      <Container97 />
      <Container98 />
      <Container107 />
    </div>
    ...
    <div className="relative shrink-0 size-[20px]" data-name="Icon">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="Icon">
          ...
          <path d={svgPaths.pae3c380} id="Vector_4" stroke="var(--stroke-0, #155DFC)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
        </g>
      </svg>
    </div>
  );
...
function Container112() {
  return (
    <div className="content-stretch flex gap-[8px] h-[20.797px] items-center relative shrink-0 w-full" data-name="Container">
      <Icon6 />
      <Container113 />
    </div>
  );
...
function ListItem5() {
  return (
    <div className="h-[35.188px] relative shrink-0 w-full" data-name="List Item">
      <Text17 />
      <Text18 />
    </div>
  );
...
function List1() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] h-[107.969px] items-start relative shrink-0 w-full" data-name="List">
      <ListItem4 />
      <ListItem5 />
      <ListItem6 />
    </div>
...
function Container111() {
  return (
    <div className="absolute bg-[#eff6ff] content-stretch flex flex-col gap-[16px] h-[200.359px] items-start left-0 pb-px pt-[21px] px-[21px] rounded-[8px] top-0 w-[309.258px]" data-name="Container">
...
function Icon7() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="Icon">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g clipPath="url(#clip0_2927_1213)" id="Icon">
          <path d={svgPaths.p37143280} id="Vector" stroke="var(--stroke-0, #E17100)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d={svgPaths.p1d7f0000} id="Vector_2" stroke="var(--stroke-0, #E17100)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d={svgPaths.p2b722f80} id="Vector_3" stroke="var(--stroke-0, #E17100)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d="M8.33333 5H11.6667" id="Vector_4" stroke="var(--stroke-0, #E17100)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d="M8.33333 8.33333H11.6667" id="Vector_5" stroke="var(--stroke-0, #E17100)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d="M8.33333 11.6667H11.6667" id="Vector_6" stroke="var(--stroke-0, #E17100)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d="M8.33333 15H11.6667" id="Vector_7" stroke="var(--stroke-0, #E17100)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
        </g>
        <defs>
          <clipPath id="clip0_2927_1213">
...
function List2() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] h-[121.563px] items-start relative shrink-0 w-full" data-name="List">
      <ListItem7 />
      <ListItem8 />
      <ListItem9 />
    </div>
...
function Container114() {
  return (
    <div className="absolute bg-[#fffbeb] content-stretch flex flex-col gap-[16px] h-[200.359px] items-start left-[333.26px] pb-px pt-[21px] px-[21px] rounded-[8px] top-0 w-[309.266px]" data-name="Container">
...
function Container110() {
  return (
    <div className="h-[200.359px] relative shrink-0 w-full" data-name="Container">
      <Container111 />
      <Container114 />
    </div>
  );
...
function Container108() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] h-[237.156px] items-start relative shrink-0 w-full" data-name="Container">
      <Container109 />
      <Container110 />
    </div>
  );
...
function Container90() {
  return (
    <div className="content-stretch flex flex-col gap-[32px] h-[1180.25px] items-start relative shrink-0 w-full" data-name="Container">
      <Container91 />
      <Container96 />
      <Container108 />
    </div>
...
function MarketCatalyst() {
  return (
    <div className="h-[1386.258px] relative shrink-0 w-full" data-name="MarketCatalyst">
      <div className="content-stretch flex flex-col gap-[32px] items-start pt-[52.906px] px-[75.586px] relative size-full">
        <Container87 />
        <Container90 />
      </div>
...
function TableRow29() {
  return (
    <div className="absolute bg-white border-[#e5e7eb] border-b border-solid h-[42.094px] left-0 top-0 w-[590.523px]" data-name="Table Row">
      <TableCell56 />
      <TableCell57 />
    </div>
  );
...
function TableRow30() {
  return (
    <div className="absolute bg-[rgba(249,250,251,0.5)] border-[#e5e7eb] border-b border-solid h-[42.594px] left-0 top-[42.09px] w-[590.523px]" data-name="Table Row">
      <TableCell58 />
      <TableCell59 />
    </div>
  );
...
function TableRow31() {
  return (
    <div className="absolute bg-white border-[#e5e7eb] border-b border-solid h-[42.594px] left-0 top-[84.69px] w-[590.523px]" data-name="Table Row">
      <TableCell60 />
      <TableCell61 />
    </div>
  );
...
function TableRow32() {
  return (
    <div className="absolute bg-[rgba(249,250,251,0.5)] border-[#e5e7eb] border-b border-solid h-[42.594px] left-0 top-[127.28px] w-[590.523px]" data-name="Table Row">
      <TableCell62 />
      <TableCell63 />
    </div>
  );
...
function TableRow33() {
  return (
    <div className="absolute bg-white border-[#e5e7eb] border-b border-solid h-[42.594px] left-0 top-[169.88px] w-[590.523px]" data-name="Table Row">
      <TableCell64 />
      <TableCell65 />
    </div>
  );
...
function TableRow34() {
  return (
    <div className="absolute bg-[rgba(249,250,251,0.5)] h-[42.094px] left-0 top-[212.47px] w-[590.523px]" data-name="Table Row">
      <TableCell66 />
      <TableCell67 />
    </div>
  );
...
function TableBody5() {
  return (
    <div className="absolute h-[254.563px] left-0 top-0 w-[590.523px]" data-name="Table Body">
      <TableRow29 />
      <TableRow30 />
      <TableRow31 />
      <TableRow32 />
...
function Container124() {
  return (
    <div className="absolute bg-white h-[256.563px] left-[25px] rounded-[4px] top-[114.59px] w-[592.523px]" data-name="Container">
      <div className="content-stretch flex flex-col items-start overflow-clip p-px relative rounded-[inherit] size-full">
        <Table5 />
      </div>
      <div aria-hidden="true" className="absolute border border-[#a4f4cf] border-solid inset-0 pointer-events-none rounded-[4px]" />
...
function Container121() {
  return (
    <div className="bg-[#ecfdf5] h-[396.156px] relative rounded-[8px] shrink-0 w-full" data-name="Container">
      <div aria-hidden="true" className="absolute border border-[#a4f4cf] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <Container122 />
      <Container123 />
      <Container124 />
...
function TableRow40() {
  return (
    <div className="absolute bg-[rgba(249,250,251,0.5)] border-[#e5e7eb] border-b border-solid h-[42.594px] left-0 top-[212.47px] w-[590.523px]" data-name="Table Row">
      <TableCell78 />
      <TableCell79 />
    </div>
  );
...
function TableRow41() {
  return (
    <div className="absolute bg-white h-[42.094px] left-0 top-[255.06px] w-[590.523px]" data-name="Table Row">
      <TableCell80 />
      <TableCell81 />
    </div>
  );
...
function TableBody6() {
  return (
    <div className="absolute h-[297.156px] left-0 top-0 w-[590.523px]" data-name="Table Body">
      <TableRow35 />
      <TableRow36 />
      <TableRow37 />
      <TableRow38 />
...
function Table6() {
  return (
    <div className="h-[297.156px] relative shrink-0 w-full" data-name="Table">
      <TableBody6 />
    </div>
  );
}
...
function Container127() {
  return (
    <div className="h-[299.156px] relative rounded-[4px] shrink-0 w-full" data-name="Container">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col items-start p-px relative size-full">
          <Table6 />
        </div>
...
function Container125() {
  return (
    <div className="h-[398.75px] relative rounded-[8px] shrink-0 w-full" data-name="Container">
...
function Container128() {
  return (
    <div className="h-[356.156px] relative rounded-[8px] shrink-0 w-full" data-name="Container">
      <div aria-hidden="true" className="absolute border border-[#e5e7eb] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <div className="content-stretch flex flex-col gap-[24px] items-start pb-px pt-[25px] px-[25px] relative size-full">
        <Container129 />
        <Container130 />
...
function Container120() {
  return (
    <div className="content-stretch flex flex-col gap-[32px] h-[1215.063px] items-start relative shrink-0 w-full" data-name="Container">
      <Container121 />
      <Container125 />
      <Container128 />
    </div>
...
function StrategyOptions() {
  return (
    <div className="h-[1421.07px] relative shrink-0 w-full" data-name="StrategyOptions">
      <div className="content-stretch flex flex-col gap-[32px] items-start pt-[52.906px] px-[75.586px] relative size-full">
        <Container117 />
        <Container120 />
      </div>
...
function Text27() {
  return (
    <div className="absolute bg-[#fef3c6] h-[24px] left-[16px] rounded-[4px] top-[12px] w-[57.461px]" data-name="Text">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[16px] left-[8px] not-italic text-[#bb4d00] text-[10px] top-[4px] tracking-[0.1172px] whitespace-nowrap">MEDIUM</p>
    </div>
  );
}
...
function TableRow49() {
  return (
    <div className="absolute bg-white border-[#e5e7eb] border-b border-solid h-[48.5px] left-0 top-0 w-[640.523px]" data-name="Table Row">
      <TableCell94 />
      <TableCell95 />
    </div>
  );
...
function Text28() {
  return (
    <div className="absolute bg-[#d0fae5] h-[24px] left-[16px] rounded-[4px] top-[12.5px] w-[38.844px]" data-name="Text">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[16px] left-[8px] not-italic text-[#007a55] text-[10px] top-[4px] tracking-[0.1172px] whitespace-nowrap">LOW</p>
    </div>
  );
}
...
function TableRow50() {
  return (
    <div className="absolute bg-[rgba(249,250,251,0.5)] border-[#e5e7eb] border-b border-solid h-[49px] left-0 top-[48.5px] w-[640.523px]" data-name="Table Row">
      <TableCell96 />
      <TableCell97 />
    </div>
  );
...
function Text29() {
  return (
    <div className="absolute bg-[#fef3c6] h-[24px] left-[16px] rounded-[4px] top-[12.5px] w-[57.461px]" data-name="Text">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[16px] left-[8px] not-italic text-[#bb4d00] text-[10px] top-[4px] tracking-[0.1172px] whitespace-nowrap">MEDIUM</p>
    </div>
  );
}
...
function TableRow51() {
  return (
    <div className="absolute bg-white border-[#e5e7eb] border-b border-solid h-[49px] left-0 top-[97.5px] w-[640.523px]" data-name="Table Row">
      <TableCell98 />
      <TableCell99 />
    </div>
  );
...
function TableRow52() {
  return (
    <div className="absolute bg-[rgba(249,250,251,0.5)] border-[#e5e7eb] border-b border-solid h-[49px] left-0 top-[146.5px] w-[640.523px]" data-name="Table Row">
      <TableCell100 />
      <TableCell101 />
    </div>
  );
...
function TableRow53() {
  return (
    <div className="absolute bg-white h-[48.5px] left-0 top-[195.5px] w-[640.523px]" data-name="Table Row">
      <TableCell102 />
      <TableCell103 />
    </div>
  );
...
function TableBody8() {
  return (
    <div className="absolute h-[244px] left-0 top-[41.59px] w-[640.523px]" data-name="Table Body">
      <TableRow49 />
      <TableRow50 />
      <TableRow51 />
      <TableRow52 />
...
function Table8() {
  return (
    <div className="h-[285.594px] relative shrink-0 w-full" data-name="Table">
      <TableHeader1 />
      <TableBody8 />
    </div>
  );
...
function Container137() {
  return (
    <div className="h-[287.594px] relative rounded-[4px] shrink-0 w-full" data-name="Container">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col items-start p-px relative size-full">
          <Table8 />
        </div>
...
function Container135() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] h-[324.391px] items-start relative shrink-0 w-full" data-name="Container">
      <Container136 />
      <Container137 />
    </div>
  );
...
function TableBody9() {
  return (
    <div className="absolute h-[169.375px] left-0 top-[41.59px] w-[640.523px]" data-name="Table Body">
      <TableRow55 />
      <TableRow56 />
      <TableRow57 />
      <TableRow58 />
...
function Table9() {
  return (
    <div className="h-[210.969px] relative shrink-0 w-full" data-name="Table">
      <TableHeader2 />
      <TableBody9 />
    </div>
  );
...
function Container140() {
  return (
    <div className="h-[212.969px] relative rounded-[4px] shrink-0 w-full" data-name="Container">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col items-start p-px relative size-full">
          <Table9 />
        </div>
...
function Container138() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] h-[249.766px] items-start relative shrink-0 w-full" data-name="Container">
      <Container139 />
      <Container140 />
    </div>
  );
...
function Container146() {
  return (
    <div className="absolute bg-[rgba(255,255,255,0.7)] content-stretch flex flex-col gap-[12px] h-[173.969px] items-start left-[25px] pb-px pt-[17px] px-[17px] rounded-[4px] top-[109.8px] w-[592.523px]" data-name="Container">
      <div aria-hidden="true" className="absolute border border-[#a4f4cf] border-solid inset-0 pointer-events-none rounded-[4px]" />
      <Container147 />
      <List3 />
    </div>
...
function Container152() {
  return (
    <div className="absolute h-[16px] left-[12px] top-[59.19px] w-[262.258px]" data-name="Container">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[16px] left-0 not-italic text-[#6a7282] text-[10px] top-0 tracking-[0.1172px] whitespace-nowrap">+59% appreciation</p>
    </div>
  );
}
...
function Container149() {
  return (
    <div className="absolute bg-[rgba(255,255,255,0.7)] border border-[#a4f4cf] border-solid h-[89.188px] left-0 rounded-[4px] top-0 w-[288.258px]" data-name="Container">
      <Container150 />
      <Container151 />
      <Container152 />
    </div>
...
function Container156() {
  return (
    <div className="absolute h-[16px] left-[12px] top-[59.19px] w-[262.266px]" data-name="Container">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[16px] left-0 not-italic text-[#6a7282] text-[10px] top-0 tracking-[0.1172px] whitespace-nowrap">+129% appreciation</p>
    </div>
  );
}
...
function Container153() {
  return (
    <div className="absolute bg-[rgba(255,255,255,0.7)] border border-[#a4f4cf] border-solid h-[89.188px] left-[304.26px] rounded-[4px] top-0 w-[288.266px]" data-name="Container">
      <Container154 />
      <Container155 />
      <Container156 />
    </div>
...
function Container148() {
  return (
    <div className="absolute h-[89.188px] left-[25px] top-[307.77px] w-[592.523px]" data-name="Container">
      <Container149 />
      <Container153 />
    </div>
  );
...
function Container143() {
  return (
    <div className="bg-[#ecfdf5] h-[421.953px] relative rounded-[8px] shrink-0 w-full" data-name="Container">
      <div aria-hidden="true" className="absolute border border-[#a4f4cf] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <Container144 />
      <Container145 />
      <Container146 />
...
function Container141() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] h-[458.75px] items-start relative shrink-0 w-full" data-name="Container">
      <Container142 />
      <Container143 />
    </div>
  );
...
function Container134() {
  return (
    <div className="content-stretch flex flex-col gap-[32px] h-[1096.906px] items-start relative shrink-0 w-full" data-name="Container">
      <Container135 />
      <Container138 />
      <Container141 />
    </div>
...
function RecommendationLogic() {
  return (
    <div className="h-[1302.914px] relative shrink-0 w-full" data-name="RecommendationLogic">
      <div className="content-stretch flex flex-col gap-[32px] items-start pt-[52.906px] px-[75.586px] relative size-full">
        <Container131 />
        <Container134 />
      </div>
...
function Container161() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[16px] h-[293.359px] items-start left-0 top-0 w-[642.523px]" data-name="Container">
      <Container162 />
      <Container163 />
    </div>
  );
...
function Container170() {
  return (
    <div className="content-stretch flex flex-col h-[35.188px] items-start relative shrink-0 w-full" data-name="Container">
      <Container171 />
      <Container172 />
    </div>
  );
...
function Container167() {
  return (
    <div className="absolute bg-[rgba(236,253,245,0.3)] content-stretch flex flex-col gap-[16px] h-[252.344px] items-start left-0 pb-px pt-[21px] px-[21px] rounded-[8px] top-0 w-[198.172px]" data-name="Container">
      <div aria-hidden="true" className="absolute border border-[#e5e7eb] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <Container168 />
      <Container169 />
    </div>
...
function Container182() {
  return (
    <div className="absolute bg-[rgba(239,246,255,0.3)] content-stretch flex flex-col gap-[16px] h-[252.344px] items-start left-[222.17px] pb-px pt-[21px] px-[21px] rounded-[8px] top-0 w-[198.172px]" data-name="Container">
      <div aria-hidden="true" className="absolute border border-[#e5e7eb] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <Container183 />
      <Container184 />
    </div>
...
function Container197() {
  return (
    <div className="absolute bg-[rgba(255,251,235,0.3)] content-stretch flex flex-col gap-[16px] h-[252.344px] items-start left-[444.34px] pb-px pt-[21px] px-[21px] rounded-[8px] top-0 w-[198.18px]" data-name="Container">
      <div aria-hidden="true" className="absolute border border-[#e5e7eb] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <Container198 />
      <Container199 />
    </div>
...
function Container166() {
  return (
    <div className="h-[252.344px] relative shrink-0 w-full" data-name="Container">
      <Container167 />
      <Container182 />
      <Container197 />
    </div>
...
function Container164() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[16px] h-[289.141px] items-start left-0 top-[325.36px] w-[642.523px]" data-name="Container">
      <Container165 />
      <Container166 />
    </div>
  );
  ...
  return (
    <div className="absolute left-0 size-[12px] top-[2px]" data-name="Icon">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 12 12">
        <g clipPath="url(#clip0_2927_1234)" id="Icon">
          <path d={svgPaths.p3e7757b0} id="Vector" stroke="var(--stroke-0, #009966)" strokeLinecap="round" strokeLinejoin="round" />
          <path d="M4.5 6L5.5 7L7.5 5" id="Vector_2" stroke="var(--stroke-0, #009966)" strokeLinecap="round" strokeLinejoin="round" />
        </g>
        <defs>
          <clipPath id="clip0_2927_1234">
...
function ListItem14() {
  return (
    <div className="h-[17.594px] relative shrink-0 w-full" data-name="List Item">
      <Icon8 />
      <Text40 />
    </div>
  );
...
function List4() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] h-[60.781px] items-start relative shrink-0 w-full" data-name="List">
      <ListItem14 />
      <ListItem15 />
      <ListItem16 />
    </div>
...
function Container218() {
  return (
    <div className="flex-[536.523_0_0] h-[89.578px] min-h-px min-w-px relative" data-name="Container">
...
function Container216() {
  return (
    <div className="content-stretch flex gap-[16px] h-[89.578px] items-start relative shrink-0 w-full" data-name="Container">
      <Container217 />
      <Container218 />
    </div>
  );
...
function Container215() {
  return (
    <div className="bg-[#f9fafb] h-[131.578px] relative rounded-[8px] shrink-0 w-full" data-name="Container">
      <div aria-hidden="true" className="absolute border border-[#e5e7eb] border-solid inset-0 pointer-events-none rounded-[8px]" />
...
function Icon11() {
  return (
    <div className="absolute left-0 size-[12px] top-[2px]" data-name="Icon">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 12 12">
        <g clipPath="url(#clip0_2927_1226)" id="Icon">
          <path d={svgPaths.p3e7757b0} id="Vector" stroke="var(--stroke-0, #155DFC)" strokeLinecap="round" strokeLinejoin="round" />
          <path d="M4.5 6L5.5 7L7.5 5" id="Vector_2" stroke="var(--stroke-0, #155DFC)" strokeLinecap="round" strokeLinejoin="round" />
        </g>
        <defs>
          <clipPath id="clip0_2927_1226">
            <rect fill="white" height="12" width="12" />
          </clipPath>
        </defs>
      </svg>
...
function List5() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] h-[82.375px] items-start relative shrink-0 w-full" data-name="List">
      <ListItem17 />
      <ListItem18 />
      <ListItem19 />
      <ListItem20 />
...
function Container223() {
  return (
    <div className="flex-[536.523_0_0] h-[111.172px] min-h-px min-w-px relative" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[8px] items-start relative size-full">
        <Container224 />
        <List5 />
      </div>
...
function Container221() {
  return (
    <div className="content-stretch flex gap-[16px] h-[111.172px] items-start relative shrink-0 w-full" data-name="Container">
      <Container222 />
      <Container223 />
    </div>
  );
...
function Container220() {
  return (
    <div className="bg-[#f9fafb] h-[153.172px] relative rounded-[8px] shrink-0 w-full" data-name="Container">
      <div aria-hidden="true" className="absolute border border-[#e5e7eb] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <div className="content-stretch flex flex-col items-start pb-px pt-[21px] px-[21px] relative size-full">
        <Container221 />
      </div>
...
function Icon15() {
  return (
    <div className="absolute left-0 size-[12px] top-[2px]" data-name="Icon">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 12 12">
        <g clipPath="url(#clip0_2927_1230)" id="Icon">
          <path d={svgPaths.p3e7757b0} id="Vector" stroke="var(--stroke-0, #E17100)" strokeLinecap="round" strokeLinejoin="round" />
          <path d="M4.5 6L5.5 7L7.5 5" id="Vector_2" stroke="var(--stroke-0, #E17100)" strokeLinecap="round" strokeLinejoin="round" />
        </g>
        <defs>
          <clipPath id="clip0_2927_1230">
            <rect fill="white" height="12" width="12" />
          </clipPath>
        </defs>
      </svg>
...
function Icon19() {
  return (
    <div className="absolute left-0 size-[12px] top-[2px]" data-name="Icon">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 12 12">
        <g clipPath="url(#clip0_2927_1222)" id="Icon">
          <path d={svgPaths.p3e7757b0} id="Vector" stroke="var(--stroke-0, #9810FA)" strokeLinecap="round" strokeLinejoin="round" />
          <path d="M4.5 6L5.5 7L7.5 5" id="Vector_2" stroke="var(--stroke-0, #9810FA)" strokeLinecap="round" strokeLinejoin="round" />
        </g>
        <defs>
          <clipPath id="clip0_2927_1222">
            <rect fill="white" height="12" width="12" />
          </clipPath>
        </defs>
      </svg>
...
function Container214() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] h-[639.094px] items-start relative shrink-0 w-full" data-name="Container">
      <Container215 />
      <Container220 />
      <Container225 />
      <Container230 />
...
function Container212() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[16px] h-[675.891px] items-start left-0 top-[646.5px] w-[642.523px]" data-name="Container">
      <Container213 />
      <Container214 />
    </div>
  );
...
function Paragraph2() {
  return (
    <div className="h-[81.25px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[16.25px] left-0 not-italic text-[#364153] text-[10px] top-0 tracking-[0.1172px] w-[591px]">This report has been prepared for advisory purposes only and does not constitute an offer or investment recommendation. All projections, forecasts, and valuations are subject to uncertainty and actual results may differ materially due to market conditions, regulatory changes, or other factors. The recipient must conduct independent due diligence and consult qualified legal, financial, and tax advisors before making any investment decisions. Vybe Realty and the report authors assume no liability for decisions based on this report.</p>
    </div>
  );
}
...
function Container235() {
  return (
    <div className="absolute bg-[#f3f4f6] content-stretch flex flex-col gap-[12px] h-[160.844px] items-start left-0 pb-px pt-[25px] px-[25px] rounded-[8px] top-[1370.39px] w-[642.523px]" data-name="Container">
...
function Container238() {
  return (
    <div className="h-[16px] relative shrink-0 w-full" data-name="Container">
      <p className="-translate-x-1/2 absolute font-['Inter:Regular',sans-serif] font-normal leading-[16px] left-[321.04px] not-italic text-[#6a7282] text-[10px] text-center top-0 tracking-[0.1172px] whitespace-nowrap">Prepared as independent strategic advisory for capital deployment decision-making</p>
    </div>
  );
}
...
function Container237() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[8px] h-[65px] items-start left-0 pt-[25px] top-[1563.23px] w-[642.523px]" data-name="Container">
...
function Container160() {
  return (
    <div className="h-[1628.234px] relative shrink-0 w-full" data-name="Container">
      <Container161 />
      <Container164 />
      <Container212 />
      <Container235 />
...
function Appendix() {
  return (
    <div className="h-[1834.242px] relative shrink-0 w-full" data-name="Appendix">
      <div className="content-stretch flex flex-col gap-[32px] items-start pt-[52.906px] px-[75.586px] relative size-full">
        <Container157 />
        <Container160 />
      </div>
...
function Container() {
  return (
    <div className="bg-white content-stretch flex flex-col h-[9033.641px] items-start relative shrink-0 w-full" data-name="Container">
      <TitlePage />
      <ExecutiveSummary />
      <PropertyOverview />
      <MarketCatalyst />
