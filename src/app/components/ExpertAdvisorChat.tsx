...
export function ExpertAdvisorChat({ onClose, propertyContext }: ExpertAdvisorChatProps) {
  ...
  return (
    <div className="fixed inset-y-0 right-0 w-[480px] bg-white dark:bg-[#0d1b2e] border-l border-[#E2E8F0] dark:border-white/[0.06] shadow-[-8px_0_32px_rgba(0,0,0,0.12)] dark:shadow-[-8px_0_32px_rgba(0,0,0,0.6)] flex flex-col z-50">
      {/* Header */}
      <div className="flex items-center justify-between px-6 py-4 border-b border-[#E2E8F0] dark:border-white/[0.06] bg-gradient-to-r from-purple-500/5 to-blue-500/5">
        ...
        {onClose && (
          <button
            onClick={onClose}
            className="w-8 h-8 rounded-xl bg-[#0B1F3A]/[0.03] dark:bg-white/[0.03] hover:bg-[#0B1F3A]/[0.08] dark:hover:bg-white/[0.08] flex items-center justify-center transition-colors"
          >
                        ...
                        <div>
                          ...
                          <div className="flex gap-2">
                            <button
                              ...
                              className="flex-1 px-3 py-2 rounded-xl bg-gradient-to-br from-emerald-500 to-green-500 text-white text-xs font-normal hover:shadow-lg transition-all flex items-center justify-center gap-1.5"
                            >
                            ...
                            <button
                              ...
                              className="px-4 py-2 rounded-xl bg-[#0B1F3A]/5 dark:bg-white/5 text-[#0F172A]/70 dark:text-white/70 text-xs font-normal hover:bg-[#0B1F3A]/10 dark:hover:bg-white/10 transition-all"
                            >
                              Cancel
                            </button>
                          </div>
                    ...
                    <div className="mt-3 space-y-2">
                      {message.suggestions.map((suggestion, idx) => (
                        <button
                          ...
                          className="w-full text-left px-4 py-2.5 rounded-xl bg-white dark:bg-[#0d1b2e] border border-[#E2E8F0] dark:border-white/[0.06] text-xs text-[#0F172A]/70 dark:text-white/70 hover:border-[#E2E8F0] dark:hover:border-white/[0.15] hover:bg-[#0B1F3A]/[0.02] dark:hover:bg-white/[0.02] transition-all flex items-center justify-between group"
                        >
          ...
          <div className="flex gap-3">
            ...
            <div className="px-4 py-3 rounded-2xl bg-gradient-to-br from-black/[0.03] to-black/[0.06] dark:from-white/[0.03] dark:to-white/[0.06] border border-[#E2E8F0] dark:border-white/[0.06]">
              <div className="flex gap-1.5">
                <div className="w-2 h-2 rounded-full bg-[#0B1F3A]/30 dark:bg-white/30 animate-pulse"></div>
                <div className="w-2 h-2 rounded-full bg-[#0B1F3A]/30 dark:bg-white/30 animate-pulse" style={{ animationDelay: '0.2s' }}></div>
                <div className="w-2 h-2 rounded-full bg-[#0B1F3A]/30 dark:bg-white/30 animate-pulse" style={{ animationDelay: '0.4s' }}></div>
              </div>
            </div>
          </div>
        )}
      ...
      <div className="px-6 py-4 border-t border-[#E2E8F0] dark:border-white/[0.06] bg-gradient-to-r from-black/[0.01] to-black/[0.02] dark:from-white/[0.01] dark:to-white/[0.02]">
        <div className="flex gap-3">
          <input
            ...
            className="flex-1 px-4 py-3 rounded-2xl bg-white dark:bg-[#0d1b2e] border border-[#E2E8F0] dark:border-white/[0.06] text-sm text-[#0F172A] dark:text-white placeholder:text-[#94A3B8] dark:placeholder:text-white/40 focus:outline-none focus:border-purple-500/50 dark:focus:border-purple-500/50 transition-colors"
          />
          <button
