...
export function ServiceCard({
 ...
 {categoryName && (
 <div className="text-caption font-medium tracking-[0.05em] uppercase text-gray-400 dark:text-white/50 mb-1.5">
 {categoryName}
 </div>
 )}
 <h3 className="text-h2 md:text-h1 font-semibold tracking-tight text-gray-900 dark:text-white">
 {name}
 </h3>
 </div>
 {badge && (
 <div className="flex-shrink-0 px-3 py-1.5 bg-amber-500/20 rounded-lg border border-amber-500/30">
 <span className="text-caption font-semibold tracking-[0.05em] uppercase text-amber-600 dark:text-amber-400 whitespace-nowrap">
 {badge}
 </span>
 </div>
 )}
 ...
 <span className="text-caption font-semibold tracking-[0.05em] uppercase text-blue-700 dark:text-blue-400">
 ...
 <span className="text-caption font-semibold tracking-[0.05em] uppercase text-emerald-700 dark:text-emerald-400">
 ...
 <span className="font-semibold">{attributes.length}</span> options available
 </span>
 </div>
 )}
 ...
 className="flex items-center justify-center gap-2 text-small font-semibold
