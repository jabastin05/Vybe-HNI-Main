  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] dark:bg-[#0a0a0a] transition-colors duration-300">
      ...
      <div className="md:hidden">
        ...
        {/* Navy Hero Header */}
        <div className="bg-[#0B1F3A] px-4 pt-5 pb-0">
          {/* Decorative blur circles */}
          <div className="absolute top-16 right-4 w-24 h-24 rounded-full bg-[#C9A75D]/10 blur-2xl pointer-events-none" />
              ...
              {serviceCategories.map((cat) => {
                ...
                return (
                  <button
                    ...
                    `}
                  >
                    <Icon className={`w-3.5 h-3.5 flex-shrink-0 ${isActive ? 'text-[#0B1F3A]' : 'text-white/50'}`} />
                    {cat.name}
                  </button>
                );
              })}
        ...
        {selectedCategoryData && (
          <div className="px-4 py-3 bg-white dark:bg-[#0d1b2e] border-b border-[#F1F5F9] dark:border-white/[0.06]">
            <div className="flex items-center justify-between">
              ...
              <span className="text-xs font-normal text-[#C9A75D] bg-[#C9A75D]/10 px-2.5 py-1 rounded-full">
              ...
              return (
                ...
                >
                  <div className="bg-white dark:bg-[#0d1b2e] rounded-2xl overflow-hidden
                    ...
                    <div className="flex">
                      {/* Gold left accent */}
                      <div className="w-[3px] bg-[#C9A75D] flex-shrink-0" />
                      ...
                      <div className="flex-1 p-4">
                        ...
                        {primaryAttr && (
                          <div className="flex items-center gap-2 mb-3">
                            ...
                            {service.attributes.length > 1 && (
                              <span className="text-[10px] font-normal text-[#C9A75D]">
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <div className="flex items-center gap-1 text-[#C9A75D] flex-shrink-0">
        ...
        <div className="px-4 pb-6">
          <div className="bg-gradient-to-br from-[#0B1F3A] to-[#0f2a50] rounded-2xl p-4
                          border border-[#1a3a5c]
                          shadow-[0_4px_24px_rgba(11,31,58,0.20)]">
              ...
              <div className="flex-1 min-w-0">
                ...
                <button
                  ...
                  className="flex items-center gap-1.5 px-3.5 py-2 bg-[#C9A75D] text-[#0B1F3A]
                             ...
                             active:scale-95 shadow-[0_2px_12px_rgba(201,167,93,0.4)]"
                >
                  Get Recommendations
                  <ArrowRight className="w-3.5 h-3.5" />
                </button>
      ...
      <div className="hidden md:block">
        ...
        <div className="max-w-[1200px] mx-auto container-padding py-6 md:py-8 lg:py-10">
                  ...
                  return (
                    <button
                      ...
                      className={`
                        ...
                        ${isSelected
                          ? 'border-2 border-[#0B1F3A] shadow-[0_8px_32px_rgba(11,31,58,0.20)] dark:border-[#C9A75D] dark:shadow-[0_8px_32px_rgba(201,167,93,0.20)]'
                    ...
                    >
                      ...
                      <div className="flex items-center justify-between pt-3 border-t border-[#F1F5F9] dark:border-white/5">
                        ...
                        {isSelected && (
                          <div className="w-2 h-2 rounded-full bg-[#C9A75D] animate-pulse" />
                        )}
                      </div>
                    </button>
                  );
          ...
          <div className="mb-6">
            <div className="relative">
              ...
              <input
                ...
                value={searchQuery}
                onChange={(e) => setSearchQuery(e.target.value)}
                className="w-full pl-12 pr-4 py-4 bg-white dark:bg-[#0d1b2e] border border-[#E2E8F0] dark:border-white/[0.06] rounded-xl text-small text-[#0F172A] dark:text-white placeholder:text-[#0F172A]/40 dark:placeholder:text-white/40 focus:outline-none focus:border-[#0B1F3A]/30 dark:focus:border-[#C9A75D]/30"
              />
            </div>
          </div>
          ...
          {/* Info Card */}
          <div className="mt-12 bg-gradient-to-br from-[#0B1F3A]/[0.04] to-[#C9A75D]/[0.04] border border-[#0B1F3A]/10 dark:border-[#C9A75D]/20 backdrop-blur-xl rounded-xl p-4 md:p-5 lg:p-6">
            <div className="flex items-start gap-6">
              <div className="w-14 h-14 rounded-xl bg-[#0B1F3A]/[0.08] dark:bg-[#C9A75D]/10 flex items-center justify-center flex-shrink-0">
                <Sparkles className="w-7 h-7 text-[#0B1F3A] dark:text-[#C9A75D]" />
              </div>
              <div className="flex-1">
                ...
                <button
                  onClick={() => navigate('/help-support')}
                  className="flex items-center gap-2 px-5 py-2.5 bg-[#0B1F3A] hover:bg-[#0f2a50] text-white rounded-xl text-small font-normal transition-all shadow-sm"
                >
