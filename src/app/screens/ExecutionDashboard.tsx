    ...
    <div className="min-h-screen bg-[#F8FAFC] dark:bg-[#0a0a0a] transition-colors duration-300">
      ...
      <div className="max-w-[1200px] mx-auto container-padding py-6 md:py-8 lg:py-10">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 md:gap-6 mb-6 md:mb-8 lg:mb-10">
          <div className="bg-white dark:bg-[#0d1b2e] border border-[#E2E8F0] dark:border-white/[0.06] rounded-lg p-4 md:p-5 lg:p-6">
            <div className="flex items-center gap-3 mb-4">
              <div className="w-10 h-10 rounded-md bg-[#C9A75D]/10 flex items-center justify-center">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 md:gap-6">
          {/* Milestone Tracker */}
          <div className="col-span-2 bg-white dark:bg-[#0d1b2e] border border-[#E2E8F0] dark:border-white/[0.06] rounded-lg p-10">
            ...
            {/* Progress Bar */}
            <div className="mb-10">
              <div className="h-2 rounded-full bg-[#0B1F3A]/5 dark:bg-white/5 overflow-hidden">
                <div
                    ...
                    <div className="flex-1 pb-4">
                      <div className="flex items-start justify-between mb-2">
                        ...
                        {isCompleted && milestone.completedDate && (
                          <span className="text-caption text-emerald-400 bg-[#C9A75D]/10 px-6 py-2.5 rounded">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white dark:bg-[#0d1b2e] border border-[#E2E8F0] dark:border-white/[0.06] rounded-lg p-4 md:p-5 lg:p-6">
              <div className="flex items-center justify-between mb-6">
                ...
                <button className="p-2 bg-[#0B1F3A]/5 dark:bg-white/5 rounded-md hover:bg-[#0B1F3A]/10 dark:hover:bg-white/10 transition-colors">
                  <Upload className="w-4 h-4 text-[#475569] dark:text-white/50" />
                </button>
              </div>
              <div className="space-y-3">
                {documents.map((doc, index) => (
                  <div key={index} className="bg-[#0B1F3A]/[0.02] dark:bg-white/[0.02] border border-[#E2E8F0] dark:border-white/[0.06] rounded-md p-4">
            ...
            <div className="bg-white dark:bg-[#0d1b2e] border border-[#E2E8F0] dark:border-white/[0.06] rounded-lg p-4 md:p-5 lg:p-6">
              ...
              <button className="w-full flex items-center justify-center gap-2 bg-[#0B1F3A]/5 dark:bg-white/5 text-[#0F172A] dark:text-white/95 px-4 py-2.5 rounded-md hover:bg-[#0B1F3A]/10 dark:hover:bg-white/10 transition-colors text-small tracking-wide border border-[#E2E8F0] dark:border-white/[0.06]">
        ...
        {/* Activity Log */}
        <div className="mt-6 bg-white dark:bg-[#0d1b2e] border border-[#E2E8F0] dark:border-white/[0.06] rounded-lg p-10">
          <h3 className="text-small tracking-[0.05em] uppercase text-[#94A3B8] dark:text-white/50 mb-8">
            Activity Log
          </h3>
