...
export function SignUp() {
 ...
 <p className="text-xs tracking-[0.16em] uppercase text-brand-primary mb-2">Get Started</p>
 <h1 className="text-2xl font-normal text-gray-900 dark:text-white tracking-tight leading-none mb-1.5">Join VYBE</h1>
 <p className="text-sm text-gray-500 dark:text-white/50">Create your account to start analysing properties</p>
 </div>
 ) : (
 <div className="text-center">
 ...
 <p className="text-sm text-gray-500 dark:text-white/50">Code sent to <span className="text-brand-primary">{formData.email}</span></p>
 </div>
 )}
 </div>
