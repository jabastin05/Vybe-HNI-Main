        ...
        <div className="max-w-[1200px] mx-auto container-padding py-4 md:py-5">
          <div className="flex items-center justify-between">
            <Link to="/" className="flex items-center gap-2.5">
              <img src={vybeLogoImage} alt="VYBE" className="w-9 h-9 object-contain" />
              <div className="flex items-center gap-1">
                <span className="text-body font-normal tracking-tight text-[#0F172A] dark:text-white">VYBE</span>
                <span className="w-1.5 h-1.5 rounded-full bg-[#C9A75D] mb-2" />
              </div>
            </Link>
          ...
          {step === 'details' && (
            <>
              ...
              <div className="bg-white dark:bg-[#0d1b2e]
                              ...
                              shadow-[0_4px_24px_rgba(11,31,58,0.08)] dark:shadow-[0_4px_24px_rgba(0,0,0,0.35)]">

                {/* Gold accent bar + heading */}
                <div className="text-center mb-7">
                  <div className="h-1 w-10 rounded-full bg-[#C9A75D] mx-auto mb-5" />
                ...
                <div className="mb-6">
                  <button
                    ...
                    className="w-full bg-white dark:bg-white/[0.04]
                               ...
                               hover:border-[#0B1F3A]/20 dark:hover:border-white/20
                               hover:shadow-[0_2px_8px_rgba(11,31,58,0.08)]
                ...
                <div className="relative mb-6">
                  ...
                  <div className="relative flex justify-center">
                    <span className="bg-white dark:bg-[#0d1b2e] px-3 text-xs font-normal tracking-[0.08em] uppercase text-[#94A3B8]">
                ...
                <form onSubmit={handleSendVerification} className="space-y-4">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full bg-[#F8FAFC] dark:bg-white/[0.03]
                                   ...
                                   focus:outline-none focus:border-[#0B1F3A]/40 dark:focus:border-[#C9A75D]/40
                                   transition-colors"
                        required
                      />
                    </div>
                  ...
                  <p className="text-xs text-[#94A3B8] text-center leading-relaxed pt-1">
                    ...
                    <span className="text-[#0B1F3A] dark:text-[#C9A75D] font-normal">Terms & Conditions</span>
                    {' '}and{' '}
                    <span className="text-[#0B1F3A] dark:text-[#C9A75D] font-normal">Privacy Policy</span>
                  </p>
                  ...
                  <button
                    type="submit"
                    disabled={isLoading}
                    className="w-full bg-[#0B1F3A] hover:bg-[#0f2a50] text-white
                               px-6 py-3.5 rounded-xl
                               text-small font-normal
                               transition-all
                               hover:shadow-[0_4px_20px_rgba(11,31,58,0.40)]
                ...
                <div className="mt-6 pt-5 border-t border-[#F1F5F9] dark:border-white/[0.05] text-center">
                  <p className="text-small text-[#475569] dark:text-white/50">
                    ...
                    <Link to="/signin" className="text-[#0B1F3A] dark:text-[#C9A75D] font-normal hover:underline">
                      Sign In
                    </Link>
                  </p>
                </div>
              ...
              {/* Demo note */}
              <div className="mt-5 bg-[#0B1F3A]/[0.04] dark:bg-white/[0.03]
                              border border-[#0B1F3A]/10 dark:border-white/[0.06]
                              rounded-2xl p-4 text-center">
                <p className="text-xs text-[#94A3B8] leading-relaxed">
                  <span className="text-[#0B1F3A] dark:text-[#C9A75D] font-normal">Demo Mode —</span>{' '}
              ...
              <div className="bg-white dark:bg-[#0d1b2e]
                ...
                <button
                  ...
                  className="mb-7 text-small text-[#475569] dark:text-white/50
                             hover:text-[#0B1F3A] dark:hover:text-white
                ...
                <div className="text-center mb-7">
                  ...
                  <p className="text-small font-normal text-[#0B1F3A] dark:text-[#C9A75D]">
                    {formData.email}
                  </p>
                </div>
                ...
                <div className="text-center mb-7">
                  {canResend ? (
                    <button
                      ...
                      className="text-small font-normal text-[#0B1F3A] dark:text-[#C9A75D] hover:underline"
                    >
                      Resend Code
                    </button>
                  ) : (
