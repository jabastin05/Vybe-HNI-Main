...
export function StrategyDetail() {
  ...
  if (!property || !strategy) {
    return <div className="min-h-screen bg-[#F8FAFC] dark:bg-[#0a0a0a] flex items-center justify-center text-[#94A3B8] dark:text-white/40">Not found</div>;
  }
      ...
      <div className="px-8">
            ...
            <div className="flex items-start justify-between">
              ...
              <div className="flex items-center gap-3">
                ...
                <Link
                  ...
                  className="inline-flex items-center gap-2 bg-[#0B1F3A] dark:bg-white text-white dark:text-[#0F172A] px-6 py-2.5 rounded-md hover:bg-[#0B1F3A]/90 dark:hover:bg-white/90 transition-colors text-small tracking-wide"
                >
        ...
        <div className="max-w-[1200px] mx-auto container-padding py-6 md:py-8 lg:py-10">
          ...
          <div className="grid grid-cols-2 gap-6 mb-6">
            <div className="bg-white dark:bg-[#0d1b2e] border border-[#E2E8F0] dark:border-white/[0.06] rounded-lg p-10">
              <h3 className="text-small tracking-[0.05em] uppercase text-[#94A3B8] dark:text-white/50 mb-8">
                Sensitivity Analysis
              </h3>
              ...
              <div className="space-y-3">
                {assumptions.map((assumption, index) => (
                  <div key={index} className="flex items-start gap-3 py-2">
                    <div className="w-1.5 h-1.5 rounded-full bg-[#0B1F3A]/70 dark:bg-white/70 mt-2 flex-shrink-0" />
            ...
            <div className="space-y-4">
              {milestones.map((milestone, index) => (
                <div key={index} className="flex items-center gap-6 py-3">
                  <div className="w-8 h-8 rounded-full bg-[#0B1F3A]/5 dark:bg-white/5 flex items-center justify-center text-caption text-[#475569] dark:text-white/50 flex-shrink-0">
                    {index + 1}
                  </div>
                  ...
                  <div className="h-1 w-32 bg-[#0B1F3A]/5 dark:bg-white/5 rounded-full overflow-hidden">
                    <div className={`h-full ${milestone.status === 'completed' ? 'bg-[#0B1F3A] dark:bg-white w-full' : 'bg-[#0B1F3A] dark:bg-white w-0'}`} />
                  </div>
                </div>
              ))}
            </div>
              ...
              <div>
                ...
                <ul className="space-y-2">
                  <li className="text-small text-[#475569] dark:text-white/50 leading-relaxed flex items-start gap-2">
                    <TrendingUp className="w-4 h-4 text-[#C9A75D] mt-0.5 flex-shrink-0" />
