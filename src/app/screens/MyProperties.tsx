    ...
    <div className="min-h-screen bg-[#F8FAFC] dark:bg-[#0a0a0a] transition-colors duration-300">
      ...
      <div className="md:hidden">
        ...
        <div className="relative bg-[#0B1F3A] px-4 pt-5 pb-0 overflow-hidden">
          ...
          <div className="absolute -top-16 -right-16 w-56 h-56 rounded-full
                          bg-[#C9A75D]/[0.07] blur-2xl pointer-events-none" />
        ...
        <div className="px-4 pt-4 space-y-3">
          ...
          {properties.length === 0 ? (
            ...
            <div className="flex flex-col items-center justify-center pt-12 pb-8 px-4 text-center">
              <div className="w-16 h-16 rounded-2xl bg-[#0B1F3A]/[0.06] dark:bg-[#C9A75D]/10
                              flex items-center justify-center mb-4">
                <Building2 className="w-8 h-8 text-[#0B1F3A] dark:text-[#C9A75D]" strokeWidth={1.5} />
              </div>
              ...
              <Link
                to="/upload"
                className="inline-flex items-center gap-2 bg-[#0B1F3A] text-white
                           px-5 py-3 rounded-xl text-sm font-normal
                           shadow-[0_4px_16px_rgba(11,31,58,0.3)]
            ...
            <>
              ...
              {filteredProperties.map(property => (
                ...
                >
                  <Link
                    ...
                    className="flex bg-white dark:bg-[#0d1b2e]
                  ...
                  >
                    ...
                    <div className="w-[3px] self-stretch bg-[#C9A75D] flex-shrink-0" />
                    ...
                    <div className="flex-1 p-4">
                      ...
                      <div className="flex items-center justify-between pt-3
                        ...
                        <div className="flex items-center gap-1 text-[#C9A75D]">
              ...
              <Link
                ...
                className="flex items-center gap-4
                           ...
                           active:border-[#C9A75D]/40 active:bg-[#C9A75D]/[0.03]
      ...
      <div className="hidden md:block">
              ...
              <div className="flex items-center gap-3">
                <Link
                  ...
                  className="inline-flex items-center justify-center gap-2
                             bg-[#0B1F3A] hover:bg-[#0f2a50] text-white
                             px-5 py-2.5 rounded-xl text-small font-normal
                             transition-all hover:shadow-[0_4px_16px_rgba(11,31,58,0.35)] hover:-translate-y-0.5"
                >
        ...
        <div className="max-w-[1200px] mx-auto container-padding py-6 md:py-8">
          ...
          {properties.length === 0 ? (
            <div className="bg-white dark:bg-[#0d1b2e]
                            border border-[#E2E8F0] dark:border-white/[0.06]
                            rounded-2xl p-12 md:p-16 text-center
                            shadow-[0_4px_24px_rgba(11,31,58,0.06)]">
              <div className="w-20 h-20 rounded-2xl bg-[#0B1F3A]/[0.06] dark:bg-[#C9A75D]/10
                              flex items-center justify-center mx-auto mb-6">
                <Building2 className="w-10 h-10 text-[#0B1F3A] dark:text-[#C9A75D]" strokeWidth={1.5} />
              </div>
              ...
              <Link
                to="/upload"
                className="inline-flex items-center gap-2 bg-[#0B1F3A] hover:bg-[#0f2a50] text-white
                           px-6 py-3 rounded-xl text-small font-normal
                           transition-all hover:shadow-[0_4px_20px_rgba(11,31,58,0.4)] hover:-translate-y-0.5"
              >
            ...
            <div className="space-y-6 md:space-y-8">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 md:gap-4">
                <div className="bg-white dark:bg-[#0d1b2e]
                  ...
                  <div className="absolute left-0 top-4 bottom-4 w-[3px] rounded-r-full bg-[#C9A75D]" />
                ...
                <div className="bg-white dark:bg-[#0d1b2e] border border-[#E2E8F0] dark:border-white/[0.06] rounded-2xl p-4 md:p-5 shadow-[0_1px_3px_rgba(0,0,0,0.04)]">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-5">
                {properties.map(property => (
                  <div
                    ...
                    className="group bg-white dark:bg-[#0d1b2e]
                               ...
                               hover:shadow-[0_8px_32px_rgba(11,31,58,0.10)] dark:hover:shadow-[0_8px_32px_rgba(0,0,0,0.4)]
                               hover:-translate-y-0.5 hover:border-[#0B1F3A]/20 dark:hover:border-[#C9A75D]/20
                  ...
                  >
                    <div className="flex items-start justify-between gap-3 mb-4">
                      ...
                      <div className="flex-shrink-0 px-2.5 py-1.5 rounded-xl
                                      bg-[#0B1F3A]/[0.06] dark:bg-[#C9A75D]/10
                                      border border-[#0B1F3A]/10 dark:border-[#C9A75D]/20
                                      text-xs font-normal text-[#0B1F3A] dark:text-[#C9A75D]">
                        {property.type}
                      </div>
                    </div>
                    {property.buildingType && (
                    ...
                    <div className="flex items-center justify-between gap-3">
                      ...
                      <Link
                        ...
                        className="flex items-center gap-1.5 px-3.5 py-2 rounded-xl
                                   bg-[#0B1F3A] text-white text-small font-normal
                                   hover:bg-[#0f2a50] hover:shadow-[0_4px_12px_rgba(11,31,58,0.3)]
                ...
                <Link
                  ...
                  className="group flex flex-col items-center justify-center gap-3
                             ...
                             hover:border-[#C9A75D]/50 dark:hover:border-[#C9A75D]/40
                             hover:bg-[#C9A75D]/[0.03] transition-all duration-[250ms]"
                >
                  <div className="w-12 h-12 rounded-2xl bg-[#F8FAFC] dark:bg-white/5
                                  border border-[#E2E8F0] dark:border-white/10
                                  flex items-center justify-center
                                  group-hover:bg-[#C9A75D]/10 group-hover:border-[#C9A75D]/30
                                  transition-all">
                    <Plus className="w-5 h-5 text-[#94A3B8] group-hover:text-[#C9A75D] transition-colors" strokeWidth={2} />
                  </div>
