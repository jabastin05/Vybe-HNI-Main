      ...
      <div className="max-w-[1200px] mx-auto container-padding py-6 md:py-8 lg:py-10">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1 space-y-6">
            {/* Contact Us Card */}
            <div className="rounded-xl bg-white/80 dark:bg-[#1A1A1A] backdrop-blur-xl border border-black/5 dark:border-white/[0.08] p-4 md:p-5 lg:p-6 shadow-[0_2px_16px_rgba(0,0,0,0.04)] dark:shadow-[0_4px_24px_rgba(0,0,0,0.3)]">
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  <div className="text-h2 tracking-tight font-medium text-black dark:text-white">
                    Contact Us
                  </div>
              ...
              {/* Email */}
              <div className="mb-4 p-4 rounded-xl bg-white/60 dark:bg-white/[0.05] border border-black/5 dark:border-white/10 backdrop-blur-sm">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <a 
                      ...
                      className="text-small font-medium text-emerald-600 dark:text-emerald-400 hover:text-emerald-700 dark:hover:text-emerald-300 transition-colors break-all"
                    >
                      support@vybe.in
                    </a>
              ...
              {/* Phone */}
              <div className="p-4 rounded-xl bg-white/60 dark:bg-white/[0.05] border border-black/5 dark:border-white/10 backdrop-blur-sm">
                <div className="flex items-start gap-4">
                  <div className="w-10 h-10 rounded-lg bg-emerald-500/10 flex items-center justify-center flex-shrink-0">
                  ...
                  <div className="flex-1">
                    ...
                    <a 
                      ...
                      className="text-small font-medium text-emerald-600 dark:text-emerald-400 hover:text-emerald-700 dark:hover:text-emerald-300 transition-colors font-mono"
                    >
                      +91 80471 82000
                    </a>
                    <div className="text-caption text-black/50 dark:text-white/50 mt-1">
            ...
            <div className="rounded-xl bg-white/80 dark:bg-[#1A1A1A] backdrop-blur-xl border border-black/5 dark:border-white/[0.08] p-4 md:p-5 lg:p-6 shadow-[0_2px_16px_rgba(0,0,0,0.04)] dark:shadow-[0_4px_24px_rgba(0,0,0,0.3)]">
              ...
              <div className="space-y-2">
                ...
                >
                  <div className="text-small font-medium text-black dark:text-white group-hover:text-emerald-600 dark:group-hover:text-emerald-400 transition-colors">
          ...
          <div className="lg:col-span-2">
            <div className="rounded-xl bg-white/80 dark:bg-[#1A1A1A] backdrop-blur-xl border border-black/5 dark:border-white/[0.08] p-4 md:p-5 lg:p-6 shadow-[0_2px_16px_rgba(0,0,0,0.04)] dark:shadow-[0_4px_24px_rgba(0,0,0,0.3)]">
              ...
              <div className="flex items-center gap-3 mb-6">
                ...
                <div className="text-h1 tracking-tight font-medium text-black dark:text-white">
              ...
              <div className="mb-6 relative">
                ...
                <input
                  ...
                  className="w-full bg-white dark:bg-white/[0.02] border border-black/[0.08] dark:border-white/[0.08] rounded-xl pl-11 pr-4 py-2.5 text-small text-black dark:text-white placeholder:text-black/40 dark:placeholder:text-white/40 focus:outline-none focus:border-black/20 dark:focus:border-white/20 transition-all"
                />
              </div>

              {/* Category Filter */}
              <div className="flex flex-wrap gap-2 mb-8 pb-6 border-b border-black/5 dark:border-white/10">
                  ...
                  <button
                    ...
                    className={`px-4 py-2.5  rounded-lg text-small font-medium transition-all ${
                      selectedCategory === category.id
                        ? 'bg-black dark:bg-white text-white shadow-[0_2px_8px_rgba(16,185,129,0.3)]'
              ...
              {filteredFAQs.length > 0 ? (
                <div className="space-y-3">
                  {filteredFAQs.map((faq) => (
                    <div
                      key={faq.id}
                      className="rounded-xl bg-white/60 dark:bg-white/[0.02] border border-black/5 dark:border-white/10 overflow-hidden transition-all hover:border-emerald-500/30"
                    >
                      <button
                      ...
                      {expandedFAQ === faq.id && (
                        <div className="px-5 pb-5 pt-0">
                          <div className="text-small text-black/70 dark:text-white/70 leading-relaxed border-t border-black/5 dark:border-white/10 pt-4">
                            {faq.answer}
                          </div>
                        </div>
                      )}
                ...
                <div className="text-center py-12">
                  ...
                  <button
                    ...
                    className="mt-4 px-4 py-2.5  text-small font-medium text-emerald-600 dark:text-emerald-400 hover:text-emerald-700 dark:hover:text-emerald-300 transition-colors"
                  >
                    Clear filters
                  </button>
                </div>
              ...
              <div className="mt-8 pt-6 border-t border-black/5 dark:border-white/10">
                <div className="text-center">
                  <div className="text-small text-black/60 dark:text-white/60 mb-3">
                    Still need help? We're here for you.
                  </div>
                  <a
                    href="mailto:support@vybe.in"
                    className="inline-flex items-center gap-2 px-6 py-2.5 bg-black dark:bg-white hover:bg-black/90 dark:hover:bg-white/90 text-white rounded-lg transition-all text-small font-medium shadow-[0_4px_12px_rgba(16,185,129,0.3)] hover:shadow-[0_6px_16px_rgba(16,185,129,0.4)]"
                  >
