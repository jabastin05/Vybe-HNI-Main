...
export function ServiceDetail() {
 ...
 {/* Mobile Hero */}
 <div className="md:hidden bg-brand-navy dark:bg-background px-4 pt-5 pb-6 overflow-hidden">
 {/* Top bar */}
 ...
 {/* Category eyebrow */}
 <div className="text-[10px] font-normal tracking-[0.1em] uppercase text-brand-gold/80 mb-1.5">
 ...
 {/* Price Card */}
 <div className="relative bg-white dark:bg-card rounded-2xl border border-[#F1F5F9] dark:border-white/[0.06] p-4 md:p-5">
 <div className="flex items-center gap-3 mb-2">
 <div className="w-9 h-9 md:w-10 md:h-10 rounded-xl bg-brand-gold/10 flex items-center justify-center">
 <IndianRupee className="w-4 h-4 md:w-5 md:h-5 text-brand-gold" strokeWidth={2} />
 </div>
 ...
 <Clock className="w-4 h-4 md:w-5 md:h-5 text-brand-navy dark:text-white/70" strokeWidth={2} />
 </div>
 <span className="text-caption font-normal tracking-[0.05em] uppercase text-[#94A3B8] dark:text-white/40">
 Turnaround
 </span>
 ...
 <div className="w-9 h-9 md:w-10 md:h-10 rounded-xl bg-brand-gold/10 flex items-center justify-center">
 <CheckCircle className="w-4 h-4 md:w-5 md:h-5 text-brand-gold" strokeWidth={2} />
 </div>
 ...
 <CheckCircle className="w-4 h-4 text-brand-gold flex-shrink-0 mt-0.5" strokeWidth={2} />
 ...
 <div className="flex items-center gap-3 mb-5">
 <div className="w-9 h-9 md:w-10 md:h-10 rounded-xl bg-brand-navy/[0.07] dark:bg-white/[0.06] flex items-center justify-center">
 <FileText className="w-4 h-4 md:w-5 md:h-5 text-brand-navy dark:text-white/70" strokeWidth={2} />
 </div>
 <h2 className="text-base font-normal tracking-tight text-[#0F172A] dark:text-white">
 Requirements
 </h2>
 ...
 <div key={index} className="flex items-start gap-3">
 <div className="w-4 h-4 rounded-full border border-brand-gold/40 flex items-center justify-center flex-shrink-0 mt-0.5">
 ...
 <div className="w-9 h-9 md:w-10 md:h-10 rounded-xl bg-brand-gold/10 flex items-center justify-center">
 <Sparkles className="w-4 h-4 md:w-5 md:h-5 text-brand-gold" strokeWidth={2} />
 </div>
 <div>
 ...
 <div className="flex items-center gap-2">
 <CheckCircle className="w-4 h-4 text-brand-gold" strokeWidth={2} />
 ...
 <div className="md:hidden fixed bottom-0 left-0 right-0 bg-white dark:bg-card border-t border-[#F1F5F9] dark:border-white/[0.06] px-4 py-3 z-30">
 <button
 onClick={handleRequestService}
 ...
 {/* Modal Header */}
 <div className="sticky top-0 bg-white dark:bg-card border-b border-[#F1F5F9] dark:border-white/[0.06] px-5 py-4 rounded-t-2xl">
 ...
 ? 'border-brand-gold bg-brand-gold/5 dark:bg-brand-gold/[0.08]'
 : 'border-[#F1F5F9] dark:border-white/[0.06] hover:border-brand-gold/40 bg-white dark:bg-white/[0.03]'
 }
 `}
 >
 ...
 ${property.type === 'Apartment' ? 'bg-brand-navy/[0.07] dark:bg-white/[0.06]' : property.type === 'Villa' ? 'bg-brand-gold/10' : 'bg-brand-navy/[0.07] dark:bg-white/[0.06]'}
 `}>
 {property.type === 'Apartment' ? (
 <Building2 className="w-4 h-4 text-brand-navy dark:text-white/70" strokeWidth={2} />
 ) : property.type === 'Villa' ? (
 <Home className="w-4 h-4 text-brand-gold" strokeWidth={2} />
 ) : (
 <MapPin className="w-4 h-4 text-brand-navy dark:text-white/70" strokeWidth={2} />
 )}
 </div>
 ...
 rows={4}
 className="w-full px-4 py-3 bg-white dark:bg-white/5 border border-[#F1F5F9] dark:border-white/[0.06] rounded-xl text-small text-[#0F172A] dark:text-white placeholder:text-[#94A3B8] dark:placeholder:text-white/40 focus:outline-none focus:border-brand-gold/50 resize-none transition-colors"
 />
 </div>
 ...
 {/* Modal Footer */}
 <div className="sticky bottom-0 bg-white dark:bg-card border-t border-[#F1F5F9] dark:border-white/[0.06] px-5 py-4 rounded-b-2xl mt-auto">
 <div className="flex gap-3">
 <button
 onClick={() => setShowRequestModal(false)}
 className="flex-1 py-2.5 border border-[#F1F5F9] dark:border-white/[0.06] rounded-xl text-small font-normal text-[#0F172A] dark:text-white hover:bg-brand-navy/5 dark:hover:bg-white/5 active:bg-brand-navy/[0.08] dark:active:bg-white/[0.08] transition-colors"
 >
 Cancel
 </button>
 <button
 ...
 <CheckCircle className="w-8 h-8 text-brand-gold" strokeWidth={2} />
 </div>
 ...
 className="flex-1 py-2.5 border border-[#F1F5F9] dark:border-white/[0.06] rounded-xl text-small font-normal text-[#0F172A] dark:text-white hover:bg-brand-navy/5 dark:hover:bg-white/5 transition-colors"
 >
 Close
 </button>
 <button
