...
export function Onboarding() {
 ...
 return (
 <div className="min-h-screen w-full flex items-center justify-center p-4 md:p-5 lg:p-6 bg-[#F8FAFC] dark:bg-background overflow-y-auto">
 ...
 ? 'border-brand-gold/60 bg-brand-navy/[0.04] dark:bg-brand-gold/[0.07]'
 : 'border-[#E2E8F0] dark:border-white/[0.06] bg-[#F8FAFC] dark:bg-white/[0.03] hover:border-brand-gold/30'
 }`}
 >
 <div className={`w-10 h-10 rounded-lg flex items-center justify-center mb-3 relative ${
 data.primaryRole === role.id ? 'text-brand-gold bg-brand-gold/10' : 'text-[#94A3B8] dark:text-white/40 bg-[#F8FAFC] dark:bg-white/[0.04]'
 }`}>
 {data.primaryRole === role.id && <div className="absolute inset-0 bg-brand-gold/20 rounded-full blur-lg" />}
 ...
 >
 <div className={`w-10 h-10 rounded-lg flex items-center justify-center mb-3 relative ${
 data.portfolioSize === size.id ? 'text-brand-gold bg-brand-gold/10' : 'text-[#94A3B8] dark:text-white/40 bg-[#F8FAFC] dark:bg-white/[0.04]'
 }`}>
 {data.portfolioSize === size.id && <div className="absolute inset-0 bg-brand-gold/20 rounded-full blur-lg" />}
 ...
 data.documentType === 'aadhaar' ? 'text-brand-gold bg-brand-gold/10' : 'text-[#94A3B8] dark:text-white/40 bg-[#F8FAFC] dark:bg-white/[0.04]'
 }`}>
 ...
 >
 <div className={`w-10 h-10 rounded-lg flex items-center justify-center mb-3 ${
 data.documentType === 'pan' ? 'text-brand-gold bg-brand-gold/10' : 'text-[#94A3B8] dark:text-white/40 bg-[#F8FAFC] dark:bg-white/[0.04]'
 }`}>
 ...
 uploadedFile
 ? 'border-brand-gold/30 bg-brand-navy/[0.04] dark:bg-brand-gold/[0.07]'
 : 'border-[#E2E8F0] dark:border-white/[0.06] bg-[#F8FAFC] dark:bg-white/[0.03] hover:border-brand-gold/30 hover:bg-brand-navy/[0.04]'
 }`}
 >
 {isProcessing ? (
 <>
 ...
 <div className="p-4 rounded-xl bg-brand-navy/[0.04] dark:bg-brand-gold/[0.07] border border-brand-gold/30">
 ...
 className="w-full bg-white dark:bg-white/[0.05] border border-brand-gold/30 rounded-lg px-4 py-2.5 text-[#0F172A] dark:text-white text-small font-normal placeholder:text-[#94A3B8] dark:placeholder:text-white/30 focus:outline-none focus:border-[#E2E8F0] dark:focus:border-white/20 transition-all"
 />
