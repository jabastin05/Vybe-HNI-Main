        ...
        <div className="max-w-[1200px] mx-auto container-padding py-4">
          <div className="flex items-center justify-between">
            <Link to="/" className="flex items-center gap-2.5">
              ...
              <span className="text-body font-normal tracking-tight text-[#0F172A] dark:text-white">
                VYBE
              </span>
              {/* Gold accent dot */}
              <span className="w-1.5 h-1.5 rounded-full bg-[#C9A75D] mt-0.5" />
            </Link>
          ...
          {step === 'email' && (
            <>
              <div className="bg-white dark:bg-[#0d1b2e]
                              ...
                              shadow-[0_4px_24px_rgba(11,31,58,0.08)] dark:shadow-[0_4px_24px_rgba(0,0,0,0.4)]">

                {/* Gold accent bar at top */}
                <div className="h-1 w-12 rounded-full bg-[#C9A75D] mx-auto mb-6" />
                ...
                <div className="relative mb-5">
                  ...
                  <div className="relative flex justify-center">
                    <span className="bg-white dark:bg-[#0d1b2e] px-3
                ...
                <form onSubmit={handleSendCode} className="space-y-4">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full bg-[#F8FAFC] dark:bg-white/[0.03]
                                   ...
                                   focus:ring-2 focus:ring-[#0B1F3A]/[0.06]
                                   transition-all"
                        required
                      />
                    </div>
                  ...
                  <button
                    type="submit"
                    disabled={isLoading}
                    className="w-full bg-[#0B1F3A] hover:bg-[#0f2a50]
                               text-white px-6 py-3 rounded-xl
                               hover:shadow-[0_4px_20px_rgba(11,31,58,0.4)] hover:-translate-y-0.5
                ...
                <div className="mt-6 pt-5 border-t border-[#F1F5F9] dark:border-white/[0.05] text-center">
                  <p className="text-caption text-[#475569] dark:text-white/40">
                    ...
                    <Link to="/signup"
                          className="text-[#0B1F3A] dark:text-[#C9A75D] hover:underline font-normal">
                      Sign Up
                    </Link>
                  </p>
                </div>
              ...
              <div className="bg-white dark:bg-[#0d1b2e]
                ...
                <button
                  ...
                  className="mb-5 flex items-center gap-1.5 text-small text-[#475569] dark:text-white/50
                             hover:text-[#0B1F3A] dark:hover:text-white transition-colors"
                >
                ...
                <div className="text-center mb-7">
                  ...
                  <p className="text-small font-normal text-[#0B1F3A] dark:text-[#C9A75D] mt-1">
                    {email}
                  </p>
                </div>
                  ...
                  {verificationCode.map((digit, index) => (
                    <input
                      ...
                      className="w-11 h-13 text-center text-body font-normal
                                 ...
                                 focus:outline-none focus:border-[#0B1F3A]/50 dark:focus:border-[#C9A75D]/50
                                 focus:ring-2 focus:ring-[#0B1F3A]/[0.06]
                                 transition-all"
                      style={{ height: '52px' }}
                    />
