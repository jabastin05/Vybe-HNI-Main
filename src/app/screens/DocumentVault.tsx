...
export function DocumentVault() {
 ...
 <button
 onClick={() => navigate(id ? `/property/${id}/documents/upload` : '/documents/upload')}
 className="px-4 md:px-5 py-2.5 bg-brand-primary hover:bg-brand-primary-hover active:bg-brand-primary-active text-white rounded-xl transition-all flex items-center justify-center gap-2 text-small font-normal"
 >
 ...
 <button
 onClick={() => { setSelectedProperty('all'); setSelectedCategory('all'); }}
 className="text-caption text-brand-gold font-normal flex items-center gap-1.5"
 >
 ...
 bg-brand-navy/[0.05] dark:bg-white/[0.05]
 text-brand-navy dark:text-white text-caption font-normal
