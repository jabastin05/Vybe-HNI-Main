...
export function HabuReportView() {
 ...
 {/* Header */}
 <div className="sticky top-0 z-50 border-b border-[#E2E8F0] dark:border-white/[0.06] bg-white dark:bg-card backdrop-blur-md">
 ...
 <button 
 onClick={handleShare}
 className="inline-flex items-center gap-2 px-4 py-2.5 bg-brand-navy/5 hover:bg-brand-navy/10 dark:bg-white/5 dark:hover:bg-white/10 text-[#0F172A] dark:text-white rounded-xl text-small font-normal transition-colors"
 >
 {copied ? <Check className="w-4 h-4 text-emerald-500" /> : <Share2 className="w-4 h-4" />}
 {copied ? 'Link Copied!' : 'Share Link'}
 </button>
 <button className="inline-flex items-center gap-2 px-4 py-2.5 bg-[#1A1A1A] hover:bg-brand-navy dark:bg-white dark:hover:bg-[#F8FAFC] dark:bg-background text-white dark:text-[#1A1A1A] rounded-lg text-small font-normal transition-colors">
