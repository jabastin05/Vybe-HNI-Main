...
export function PropertyUpload() {
  ...
  return (
    <div className="min-h-screen bg-[#F2F2F2] dark:bg-[#0a0a0a] transition-colors duration-300 pb-24 md:pb-8 pt-[60px] md:pt-0">
      ...
      {/* Header - Full Width */}
      <div className="border-b border-black/5 dark:border-white/10 bg-white dark:bg-[#1A1A1A] sticky top-[60px] md:top-0 z-30">
        <div className="max-w-[1200px] mx-auto container-padding py-6">
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
            <div className="flex flex-col gap-2 w-full">
              <Link
                to="/properties"
                className="flex items-center gap-2 text-small text-black/60 dark:text-white/60 hover:text-black dark:hover:text-white transition-colors w-fit"
              >
            ...
            <div className="flex items-center gap-3">
              <div className="text-right hidden md:block">
                <div className="text-caption text-black/40 dark:text-white/50 mb-1 tracking-wider uppercase">Step</div>
                <div className="text-h1 tracking-tight text-black dark:text-white">{currentStepNumber}/3</div>
              </div>
              <div className="text-small text-black/60 dark:text-white/60 md:hidden">
      ...
      <div className="max-w-[1200px] mx-auto container-padding py-6 md:py-8 lg:py-10">
              ...
              return (
                <div key={stepName} className="flex items-center flex-1">
                  <div className={`flex items-center gap-3 flex-1 ${
                    ...
                    <div className={`w-10 h-10 rounded-full flex items-center justify-center text-small font-medium transition-all ${
                      isActive 
                    ...
                    <div className="flex-1">
                      <div className={`text-small tracking-wide ${isActive ? 'text-black dark:text-white/95' : 'text-black/50 dark:text-white/50'}`}>
                  ...
                  {index < 2 && (
                    <div className={`w-full h-px mx-3 ${
                      isCompleted ? 'bg-emerald-500/30' : 'bg-black/10 dark:bg-white/5'
                    }`} />
                  )}
                </div>
              );
        ...
        {step === 'details' && (
          <div className="space-y-6">
            <div className="bg-white dark:bg-[#1A1A1A] backdrop-blur-xl border border-black/5 dark:border-white/10 rounded-xl card-padding shadow-lg">
              <div className="flex items-center gap-3 mb-8">
                ...
                <div>
                  <h2 className="text-h2 tracking-tight text-black dark:text-white/95">
                    Property Details
                  </h2>
              ...
              <div className="space-y-6">
                ...
                <div>
                  <label className="block text-small text-black/60 dark:text-white/60 mb-3 tracking-wide">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <button
                      ...
                      className={`relative card-padding rounded-xl border transition-all duration-300 group overflow-hidden ${
                        propertyData.buildingType === 'residential'
                          ? 'border-emerald-500/50 bg-gradient-to-br from-emerald-50 to-emerald-100/50 dark:from-emerald-950/40 dark:to-emerald-900/20 shadow-xl shadow-emerald-500/20'
                          : 'border-black/10 dark:border-white/10 bg-white/50 dark:bg-white/5 hover:border-emerald-500/30 hover:bg-white/80 dark:hover:bg-white/10 hover:shadow-lg'
                      }`}
                    >
                      ...
                      <div className="relative z-10 flex flex-col items-start gap-5">
                        ...
                        <div className={`w-14 h-14 rounded-xl flex items-center justify-center transition-all duration-300 ${
                          ...
                          <svg viewBox="0 0 24 24" fill="none" className="w-7 h-7">
                            <path 
                              ...
                              stroke={propertyData.buildingType === 'residential' ? '#10b981' : '#6b7280'}
                              strokeWidth="2" 
                              strokeLinecap="round" 
                        ...
                        <div className="text-left">
                          <h3 className={`text-body font-medium mb-2 transition-colors duration-300 ${
                            propertyData.buildingType === 'residential' 
                          ...
                          <p className={`text-caption leading-relaxed transition-colors duration-300 ${
                            propertyData.buildingType === 'residential' 
                            ...
                            Apartments, villas, houses & residential plots
                          </p>
                        </div>
                      </div>
                    </button>
                      ...
                      <div className="relative z-10 flex flex-col items-start gap-5">
                        ...
                        <div className={`w-14 h-14 rounded-xl flex items-center justify-center transition-all duration-300 ${
                          ...
                          <svg viewBox="0 0 24 24" fill="none" className="w-7 h-7">
                            <path 
                              ...
                              stroke={propertyData.buildingType === 'commercial' ? '#10b981' : '#6b7280'}
                              strokeWidth="2" 
                              strokeLinecap="round" 
                              strokeLinejoin="round"
                              className="transition-colors duration-300"
                        ...
                        <div className="text-left">
                          ...
                          <p className={`text-caption leading-relaxed transition-colors duration-300 ${
                            ...
                            Offices, retail spaces, warehouses & plots
                          </p>
                        </div>
                      </div>
                    </button>
                ...
                <div>
                  ...
                  {!propertyData.buildingType ? (
                    <div className="w-full bg-black/[0.02] dark:bg-white/[0.02] border border-black/10 dark:border-white/10 rounded-xl px-6 py-2.5 text-center">
                      <p className="text-small text-black/30 dark:text-white/30">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                      {propertyTypeOptions[propertyData.buildingType]?.map((type) => (
                        <button
                          ...
                          className={`relative p-5 rounded-xl border transition-all duration-300 group overflow-hidden text-left ${ 
                            propertyData.propertyType === type
                              ? 'border-emerald-500/50 bg-gradient-to-br from-emerald-50 to-emerald-100/50 dark:from-emerald-950/40 dark:to-emerald-900/20 shadow-lg shadow-emerald-500/10'
                              : 'border-black/10 dark:border-white/10 bg-white/50 dark:bg-white/5 hover:border-emerald-500/30 hover:bg-white/80 dark:hover:bg-white/10 hover:shadow-md'
                          }`}
                        >
                          {/* Background Gradient Orb */}
                          ...
                          <div className="relative z-10">
                            ...
                            <div className={`w-10 h-10 rounded-xl flex items-center justify-center mb-3 transition-all duration-300 ${ 
                              ...
                              <Building2 className={`w-5 h-5 transition-colors duration-300 ${ 
                                propertyData.propertyType === type
                                  ? 'text-emerald-500'
                                  : 'text-black/40 dark:text-white/40 group-hover:text-emerald-500/60'
                              }`} />
                            </div>
                            
                            {/* Text Content */}
                            <h3 className={`text-small font-medium transition-colors duration-300 ${ 
                              propertyData.propertyType === type
                                ? 'text-emerald-700 dark:text-emerald-400'
                                : 'text-black/80 dark:text-white/80 group-hover:text-black dark:group-hover:text-white'
                            }`}>
                ...
                <div>
                  ...
                  />
                  <p className="text-caption text-black/30 dark:text-white/30 mt-2">
                      ...
                      <>
                        ...
                        <div>
                          ...
                          <select
                            ...
                            className="w-full bg-black/[0.02] dark:bg-white/[0.02] border border-black/10 dark:border-white/10 rounded-xl px-5 py-2.5 text-black dark:text-white/95 text-small focus:outline-none focus:border-black/20 dark:focus:border-white/20 focus:bg-black/[0.04] dark:focus:bg-black/40 transition-all appearance-none cursor-pointer"
                            style={{
                ...
                <div>
                  <button
                    ...
                    className="flex items-center gap-2 bg-black/5 hover:bg-black/10 dark:bg-white/5 dark:hover:bg-white/10 border border-black/10 dark:border-white/10 rounded-lg px-4 py-2.5 text-small text-black/80 dark:text-white/80 transition-all"
                  >
                  ...
                  {showMap && (
                    <div 
                      ...
                      className="mt-4 bg-black/5 dark:bg-white/[0.02] border border-black/10 dark:border-white/10 rounded-xl overflow-hidden h-64 flex items-center justify-center cursor-pointer hover:border-emerald-500/30 transition-all group"
                    >
                      <div className="text-center">
                        <MapIcon className="w-12 h-12 text-black/20 dark:text-white/20 group-hover:text-emerald-400 mx-auto mb-3 transition-colors" />
                        <p className="text-small text-black/40 dark:text-white/40 group-hover:text-emerald-400 transition-colors">Interactive map will load here</p>
                        <p className="text-caption text-emerald-400 mt-2">📍 Click anywhere on the map to set location</p>
                      </div>
                    </div>
                  )}
                </div>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <input
                      ...
                      className="bg-black/[0.02] dark:bg-white/[0.02] border border-black/10 dark:border-white/10 rounded-xl px-5 py-2.5 text-black dark:text-white/95 text-small placeholder:text-black/30 dark:placeholder:text-white/30 focus:outline-none focus:border-black/20 dark:focus:border-white/20 transition-all"
                    />
                    <input
                      type="text"
                ...
                {(propertyData.latitude && propertyData.longitude) && (
                  <div className="bg-emerald-500/5 border border-emerald-500/20 rounded-xl card-padding">
                    <div className="flex items-start gap-3 mb-4">
                      ...
                      <div>
                        <div className="text-small text-black dark:text-white mb-1">Location Pinned Successfully</div>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                      <div>
                        <div className="text-caption text-black/40 dark:text-white/40 mb-1 tracking-wider uppercase">Country</div>
                        <div className="text-small text-black dark:text-white/95">{propertyData.country}</div>
                      </div>
                      <div>
                        <div className="text-caption text-black/40 dark:text-white/40 mb-1 tracking-wider uppercase">State</div>
                        <div className="text-small text-black dark:text-white/95">{propertyData.state}</div>
                      </div>
                      <div>
                        <div className="text-caption text-black/40 dark:text-white/40 mb-1 tracking-wider uppercase">City</div>
                        <div className="text-small text-black dark:text-white/95">{propertyData.city}</div>
                      </div>
                      <div>
                        <div className="text-caption text-black/40 dark:text-white/40 mb-1 tracking-wider uppercase">District</div>
                        <div className="text-small text-black dark:text-white/95">{propertyData.district}</div>
                      </div>
                    </div>
                    <div className="mt-4 pt-4 border-t border-emerald-500/10">
                      <div className="text-caption text-black/40 dark:text-white/40 mb-1 tracking-wider uppercase">Coordinates</div>
                      <div className="text-small text-black/70 dark:text-white/70 font-mono">
                        {propertyData.latitude}, {propertyData.longitude}
                      </div>
                    </div>
                  </div>
              ...
              <div className="mt-8 pt-8 border-t border-black/5 dark:border-white/10 flex justify-end">
                <button
                  ...
                  className="bg-black dark:bg-white text-white dark:text-black hover:bg-black/90 dark:hover:bg-white/90 container-padding py-2.5 rounded-lg text-small tracking-wide disabled:opacity-40 disabled:cursor-not-allowed transition-all shadow-lg disabled:shadow-none w-full sm:w-auto"
                >
        ...
        {step === 'documents' && (
          <div className="space-y-6">
            ...
            <div className="bg-white/85 dark:bg-[#1A1A1A]/85 backdrop-blur-[30px] border border-black/5 dark:border-white/10 rounded-xl card-padding shadow-[0_2px_4px_rgba(0,0,0,0.02),0_20px_40px_-5px_rgba(0,0,0,0.05)] relative overflow-hidden">
              ...
              <div className="flex items-start justify-between mb-8">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <div className="mb-4">
                      <h3 className="text-h1 font-normal tracking-[-0.01em] text-black dark:text-white mb-2">
                        {propertyData.buildingType === 'residential' ? 'Residential' : 'Commercial'} {propertyData.propertyType}
                      </h3>
                      <p className="text-small font-normal text-black/60 dark:text-white/60 leading-relaxed">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-2">
                      <div className="flex items-center gap-2 bg-white/85 dark:bg-white/[0.03] backdrop-blur-[20px] border border-white/40 dark:border-white/[0.08] rounded-[12px] px-3 py-2.5 shadow-[0_2px_4px_rgba(0,0,0,0.02),0_20px_40px_-5px_rgba(0,0,0,0.05)]">
                        ...
                        <div>
                          <div className="text-caption font-medium uppercase tracking-[0.05em] text-black/40 dark:text-white/40">Security</div>
                          <div className="text-caption font-medium text-black dark:text-white/90">Bank-Grade</div>
                        </div>
                      </div>
                      ...
                      <div className="flex items-center gap-2 bg-white/85 dark:bg-white/[0.03] backdrop-blur-[20px] border border-white/40 dark:border-white/[0.08] rounded-[12px] px-3 py-2.5 shadow-[0_2px_4px_rgba(0,0,0,0.02),0_20px_40px_-5px_rgba(0,0,0,0.05)]">
                        ...
                        <div>
                          <div className="text-caption font-medium uppercase tracking-[0.05em] text-black/40 dark:text-white/40">Storage</div>
                          <div className="text-caption font-medium text-black dark:text-white/90">AI Vault</div>
                        </div>
                      </div>
                      ...
                      <div className="flex items-center gap-2 bg-white/85 dark:bg-white/[0.03] backdrop-blur-[20px] border border-white/40 dark:border-white/[0.08] rounded-[12px] px-3 py-2.5 shadow-[0_2px_4px_rgba(0,0,0,0.02),0_20px_40px_-5px_rgba(0,0,0,0.05)]">
                        ...
                        <div>
                          <div className="text-caption font-medium uppercase tracking-[0.05em] text-black/40 dark:text-white/40">Privacy</div>
                          <div className="text-caption font-medium text-black dark:text-white/90">Encrypted</div>
                        </div>
                      </div>
                      ...
                      <div className="flex items-center gap-2 bg-white/85 dark:bg-white/[0.03] backdrop-blur-[20px] border border-white/40 dark:border-white/[0.08] rounded-[12px] px-3 py-2.5 shadow-[0_2px_4px_rgba(0,0,0,0.02),0_20px_40px_-5px_rgba(0,0,0,0.05)]">
                        ...
                        <div>
                          <div className="text-caption font-medium uppercase tracking-[0.05em] text-black/40 dark:text-white/40">Backup</div>
                          <div className="text-caption font-medium text-black dark:text-white/90">Automatic</div>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div className="flex flex-col items-center gap-2">
                  <div className="w-14 h-14 rounded-full border-[3px] border-black/5 dark:border-white/10 flex items-center justify-center relative shadow-inner bg-white/50 dark:bg-black/50">
                    {(() => {
                      let totalScore = 0;
                      ...
                      return (
                        <>
                          ...
                          <span className="text-small font-medium text-emerald-600 dark:text-emerald-400">{currentScore}%</span>
                        </>
                      );
                    })()}
                  </div>
                  <span className="text-[9px] font-medium uppercase tracking-[0.05em] text-black/40 dark:text-white/40">Document Score</span>
                </div>
              </div>

              {/* Stepper Navigation */}
              <div className="flex items-center gap-6 mb-8 border-b border-black/5 dark:border-white/10 overflow-x-auto scrollbar-hide">
                  ...
                  return (
                    <button
                      ...
                      className={`flex items-center gap-2 pb-3 border-b-2 transition-colors whitespace-nowrap relative top-[1px] ${
                        isActive 
                          ? 'border-emerald-500 text-black dark:text-white' 
                          : isComplete
                            ? 'border-transparent text-black/80 dark:text-white/80 hover:text-black dark:hover:text-white'
                            : 'border-transparent text-black/40 dark:text-white/40 hover:text-black/70 dark:hover:text-white/70'
                      }`}
                    >
                      <span className={`text-small tracking-wide ${isActive ? 'font-medium' : 'font-medium'}`}>
                        {cat.title}
                      </span>
              ...
              <div className="space-y-6">
                {(() => {
                  ...
                  return (
                    <div key={categoryKey} className="p-4 md:p-5 lg:p-6 rounded-xl bg-white/40 dark:bg-black/20 border border-white/60 dark:border-white/10 shadow-sm relative overflow-hidden animate-in fade-in slide-in-from-right-4 duration-300">
                      ...
                      <div className="flex items-center justify-between mb-6">
                        <div className="flex items-center gap-3">
                          ...
                          <span className={`text-caption uppercase tracking-[0.05em] font-medium text-black dark:text-white`}>
                            {category.title} Documents
                          </span>
                          <div className="flex-1 w-12 h-px bg-gradient-to-r from-black/5 to-transparent dark:from-white/5" />
                        </div>
                        {/* Completion Badge */}
                        <div className={`px-2.5 py-1 rounded-[4px] text-caption font-medium uppercase tracking-[0.05em] ${
                          isComplete 
                      ...
                      <div className="space-y-4">
                        {category.documents.map((doc, index) => {
                          ...
                          return (
                            <div key={index}>
                              <label className="block text-small font-medium text-black/80 dark:text-white/80 mb-2 tracking-wide">
                                {doc}
                              </label>
                              <div className={`relative border rounded-[12px] transition-all duration-300 overflow-hidden ${
                                uploaded 
                                  ...
                                  : 'border-dashed border-black/15 dark:border-white/15 bg-white/50 dark:bg-black/20 hover:border-emerald-500/40 hover:bg-emerald-500/5 hover:shadow-[0_0_20px_rgba(16,185,129,0.1)]'
                              }`}>
                                <label className="flex items-center justify-between p-4 cursor-pointer group">
                                  <div className="flex items-center gap-4">
                                    <div className={`w-10 h-10 rounded-[8px] flex items-center justify-center transition-all duration-300 ${
                                      ...
                                      {uploaded ? (
                                        ...
                                        <Upload className="w-5 h-5 text-black/40 dark:text-white/40 group-hover:text-emerald-500/70 transition-colors" />
                                      )}
                                    </div>
                                    <div>
                                      <p className={`text-small font-medium mb-0.5 transition-colors ${
                                        uploaded 
                                  ...
                                  {!uploaded && (
                                    <div className="px-3.5 py-1.5 rounded-[6px] bg-black/5 dark:bg-white/5 border border-black/10 dark:border-white/10 group-hover:bg-emerald-500/10 group-hover:border-emerald-500/30 transition-all duration-300">
                                      <span className="text-caption font-medium text-black/70 dark:text-white/70 group-hover:text-emerald-600 dark:group-hover:text-emerald-400 transition-colors">
                                        Choose file
                                      </span>
                                    </div>
                                  )}
              ...
              {/* Action Buttons */}
              <div className="mt-8 pt-6 border-t border-black/5 dark:border-white/10 flex flex-col-reverse sm:flex-row items-stretch sm:items-center justify-between gap-4">
                {activeCategoryIndex > 0 ? (
                  <button
                    onClick={() => setActiveCategoryIndex(prev => prev - 1)}
                    className="text-black/60 dark:text-white/60 hover:text-black/90 dark:hover:text-white/90 text-small tracking-wide transition-colors flex items-center justify-center gap-2 px-4 py-3 sm:px-0 sm:py-0"
                  >
                ...
                {activeCategoryIndex < Object.keys(documentRequirements.categories).length - 1 ? (
                  <button
                    onClick={() => setActiveCategoryIndex(prev => prev + 1)}
                    className="bg-black/5 dark:bg-white/10 text-black dark:text-white hover:bg-black/10 dark:hover:bg-white/20 px-6 py-2.5 rounded-xl text-small tracking-wide transition-all flex items-center justify-center gap-2"
                  >
        ...
        {step === 'review' && (
          <div className="space-y-8">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white/90 dark:bg-[#0a0a0a]/90 backdrop-blur-[40px] rounded-xl border border-white/40 dark:border-white/10 p-4 md:p-5 lg:p-6 shadow-[0_2px_4px_rgba(0,0,0,0.02),0_20px_40px_-5px_rgba(0,0,0,0.05)] relative overflow-hidden">
                <div className="absolute top-0 left-0 right-0 h-[1px] bg-gradient-to-r from-transparent via-emerald-500/40 to-transparent" />
                <div className="flex items-center gap-3 mb-6">
                    <div className="w-10 h-10 rounded-lg bg-emerald-500/20 flex items-center justify-center">
                      <MapPin className="w-5 h-5 text-emerald-400" />
                    </div>
                    <h3 className="text-body tracking-tight text-black dark:text-white/95">Location Snapshot</h3>
                  </div>

                  {/* Mini Map Preview */}
                  <div className="bg-black/5 dark:bg-white/[0.02] border border-black/10 dark:border-white/10 rounded-xl overflow-hidden h-48 mb-6 flex items-center justify-center">
                    <div className="text-center">
                      <MapIcon className="w-10 h-10 text-black/20 dark:text-white/20 mx-auto mb-2" />
                      <p className="text-caption text-black/30 dark:text-white/30">Map Preview: {propertyData.address || 'Whitefield, Bangalore'}</p>
                      {propertyData.latitude && propertyData.longitude && (
                        <p className="text-caption text-black/20 dark:text-white/20 mt-1">
                          {propertyData.latitude}, {propertyData.longitude}
                        </p>
                      )}
                    </div>
                  ...
                  <div className="grid grid-cols-3 gap-4">
                    <div className="bg-black/[0.02] dark:bg-white/[0.03] border border-black/5 dark:border-white/10 rounded-xl p-4">
                      <div className="text-caption text-black/40 dark:text-white/40 mb-1 tracking-wider uppercase">Country</div>
                      <div className="text-body text-black dark:text-white/95">{propertyData.country || 'India'}</div>
                    </div>
                    <div className="bg-black/[0.02] dark:bg-white/[0.03] border border-black/5 dark:border-white/10 rounded-xl p-4">
                      <div className="text-caption text-black/40 dark:text-white/40 mb-1 tracking-wider uppercase">State</div>
                      <div className="text-body text-black dark:text-white/95">{propertyData.state || 'Karnataka'}</div>
                    </div>
                    <div className="bg-black/[0.02] dark:bg-white/[0.03] border border-black/5 dark:border-white/10 rounded-xl p-4">
                      <div className="text-caption text-black/40 dark:text-white/40 mb-1 tracking-wider uppercase">City</div>
                      <div className="text-body text-black dark:text-white/95">{propertyData.city || 'Bangalore'}</div>
                    </div>
                  </div>
              </div>

              {/* Property Details */}
              <div className="bg-white dark:bg-[#1A1A1A] backdrop-blur-xl border border-black/5 dark:border-white/10 rounded-xl p-4 md:p-5 lg:p-6 shadow-lg dark:shadow-2xl">
                  <div className="flex items-center justify-between mb-6">
                    <div className="flex items-center gap-3">
                      <div className="w-10 h-10 rounded-lg bg-blue-500/20 flex items-center justify-center">
                        <Building2 className="w-5 h-5 text-blue-400" />
                      </div>
                      <h3 className="text-body tracking-tight text-black dark:text-white/95">Property Details</h3>
                    </div>
                    <button
                      onClick={() => setStep('details')}
                  ...
                  <div className="space-y-4">
                    {/* Property Name */}
                    <div>
                      <label className="block text-caption text-black/50 dark:text-white/50 mb-2 tracking-wide uppercase">Property Name</label>
                      <div className="text-body text-black dark:text-white/95 font-medium">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div>
                        <label className="block text-caption text-black/50 dark:text-white/50 mb-2 tracking-wide uppercase">Building Type</label>
                        <div className="text-small text-black dark:text-white/95 capitalize">
                          {propertyData.buildingType || 'Not specified'}
                        </div>
                      </div>
                      <div>
                        <label className="block text-caption text-black/50 dark:text-white/50 mb-2 tracking-wide uppercase">Property Type</label>
                        <div className="text-small text-black dark:text-white/95">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div>
                        <label className="block text-caption text-black/50 dark:text-white/50 mb-2 tracking-wide uppercase">Plot Size</label>
                        <div className="text-small text-black dark:text-white/95">
                          {propertyData.plotSize ? `${propertyData.plotSize} sq ft` : 'Not provided'}
                        </div>
                      </div>
                      <div>
                        <label className="block text-caption text-black/50 dark:text-white/50 mb-2 tracking-wide uppercase">Built-up Area</label>
                        <div className="text-small text-black dark:text-white/95">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div>
                        <label className="block text-caption text-black/50 dark:text-white/50 mb-2 tracking-wide uppercase">Year of Construction</label>
                        <div className="text-small text-black dark:text-white/95">
                          {propertyData.yearOfConstruction || 'Not provided'}
                        </div>
                      </div>
                      <div>
                        <label className="block text-caption text-black/50 dark:text-white/50 mb-2 tracking-wide uppercase">Number of Floors</label>
                        <div className="text-small text-black dark:text-white/95">
                    ...
                    {/* Survey Number */}
                    <div>
                      <label className="block text-caption text-black/50 dark:text-white/50 mb-2 tracking-wide uppercase">Survey Number</label>
                      <div className="text-small text-black dark:text-white/95">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div>
                        <label className="block text-caption text-black/50 dark:text-white/50 mb-2 tracking-wide uppercase">Current Usage</label>
                        <div className="text-small text-black dark:text-white/95">
                          {propertyData.currentUsage || 'Not specified'}
                        </div>
                      </div>
                      <div>
                        <label className="block text-caption text-black/50 dark:text-white/50 mb-2 tracking-wide uppercase">Rental Income</label>
                        <div className="text-small text-black dark:text-white/95">
                    ...
                    {/* Full Address */}
                    <div>
                      <label className="block text-caption text-black/50 dark:text-white/50 mb-2 tracking-wide uppercase">Property Address</label>
                      <div className="text-small text-black dark:text-white/95">
                    ...
                    {propertyData.latitude && propertyData.longitude && (
                      <div>
                        <label className="block text-caption text-black/50 dark:text-white/50 mb-2 tracking-wide uppercase">Coordinates</label>
                        <div className="text-small text-black/60 dark:text-white/60 font-mono">
                          {propertyData.latitude}, {propertyData.longitude}
                        </div>
                      </div>
                    )}
                    ...
                    {propertyData.district && (
                      <div>
                        <label className="block text-caption text-black/50 dark:text-white/50 mb-2 tracking-wide uppercase">District</label>
                        <div className="text-small text-black dark:text-white/95">
                          {propertyData.district}
                        </div>
                      </div>
              ...
              <div className="bg-white dark:bg-[#1A1A1A] backdrop-blur-xl border border-black/5 dark:border-white/10 rounded-xl p-4 md:p-5 lg:p-6 shadow-lg dark:shadow-2xl">
                  <div className="flex items-center justify-between gap-3 mb-6">
                    <div className="flex items-center gap-3">
                      ...
                      <h3 className="text-body tracking-tight text-black dark:text-white/95">Uploaded Documents</h3>
                    </div>
                    {/* Score display */}
                    {(() => {
                      let totalScore = 0;
                      ...
                      return (
                        <div className="flex flex-col items-end">
                          <span className="text-caption text-black/40 dark:text-white/40 mb-1 font-medium tracking-wide uppercase">Trust Score</span>
                          <div className="flex items-end gap-1">
                            <span className="text-2xl font-medium leading-none text-black dark:text-white">{currentScore}</span>
                            <span className="text-small text-black/60 dark:text-white/60 mb-0.5">/ 100</span>
                          </div>
                        </div>
                      );
                    })()}
                  ...
                  {uploadedDocs.length > 0 ? (
                    <div className="flex flex-col gap-6">
                      {/* Tabs */}
                      <div className="flex items-center gap-6 border-b border-black/5 dark:border-white/10 overflow-x-auto scrollbar-hide">
                        {Object.entries(documentRequirements.categories).map(([key, cat], idx) => {
                          ...
                          if (docsToShow.length === 0) {
                            return (
                              <div className="text-center py-8">
                                ...
                                <p className="text-small text-black/40 dark:text-white/40">No documents uploaded for this category</p>
                              </div>
                            );
                          }
                          ...
                          return (
                            <div className="space-y-3">
                              {docsToShow.map((doc) => (
                                <div 
                                  key={doc.id}
                                  className="flex items-center justify-between bg-black/[0.02] dark:bg-white/[0.03] border border-black/5 dark:border-white/10 rounded-xl p-4 hover:bg-black/[0.04] dark:hover:bg-white/[0.05] transition-all"
                                >
                                  <div className="flex items-center gap-3 flex-1">
                                    ...
                                    <div className="flex-1 min-w-0">
                                      <div className="text-small text-black dark:text-white/95 truncate">
                                        {doc.documentType || doc.name}
                                      </div>
                                      <div className="text-caption text-black/40 dark:text-white/40 mt-0.5">
                    ...
                    <div className="text-center py-8">
                      <FileText className="w-12 h-12 text-black/20 dark:text-white/20 mx-auto mb-3" />
                      <p className="text-small text-black/40 dark:text-white/40">No documents uploaded yet</p>
                    </div>
                  )}
                </div>
            </div>
            ...
            {/* Action Footer */}
            <div className="bg-white dark:bg-[#1A1A1A] backdrop-blur-xl border border-black/5 dark:border-white/10 rounded-xl card-padding shadow-lg dark:shadow-2xl">
              <div className="flex flex-col-reverse sm:flex-row items-stretch sm:items-center justify-between gap-4">
                <button
                  onClick={() => setStep('documents')}
                  className="text-black/60 dark:text-white/60 hover:text-black/90 dark:hover:text-white/90 text-small tracking-wide transition-colors px-4 py-3 sm:px-0 sm:py-0 text-center sm:text-left"
                >
                  ← Back to Documents
                </button>
                ...
                <button
                  ...
                  className="bg-black dark:bg-white text-white dark:text-black hover:bg-black/90 dark:hover:bg-white/90 px-10 py-2.5 rounded-lg text-small tracking-wide transition-all shadow-lg w-full sm:w-auto"
                >
                  Finish
                </button>
              </div>
