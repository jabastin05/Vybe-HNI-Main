...
export function PartnerRouting() {
 ...
 {/* Partner Card */}
 <div className="bg-white dark:bg-card border border-[#E2E8F0] dark:border-white/[0.06] rounded-lg overflow-hidden mb-6">
 <div className="p-12">
 ...
 <div className="bg-brand-navy/[0.02] dark:bg-white/[0.02] border border-[#E2E8F0] dark:border-white/[0.06] rounded-lg p-5">
 ...
 {/* SLA Information */}
 <div className="border-t border-[#E2E8F0] dark:border-white/[0.06] bg-brand-navy/[0.02] dark:bg-white/[0.02] p-4 md:p-5 lg:p-6">
 ...
 className="flex-1 inline-flex items-center justify-center gap-2 bg-brand-navy dark:bg-white text-white dark:text-[#0F172A] px-6 py-2.5 rounded-md hover:bg-brand-navy/90 dark:hover:bg-white/90 transition-colors text-small tracking-wide"
 >
 Accept & Begin Execution
 <ArrowRight className="w-4 h-4" />
 </Link>
 <button className="flex-1 inline-flex items-center justify-center gap-2 bg-brand-navy/5 dark:bg-white/5 text-[#0F172A]/95 dark:text-white/95 px-6 py-2.5 rounded-md hover:bg-brand-navy/10 dark:hover:bg-white/10 transition-colors text-small tracking-wide border border-[#E2E8F0] dark:border-white/[0.06]">
