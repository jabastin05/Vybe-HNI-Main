      ...
      <div className="px-8">
        ...
        <div className="border-b border-black/5 dark:border-white/10 bg-white dark:bg-[#1A1A1A]">
          <div className="max-w-[1200px] mx-auto container-padding py-4 md:py-6">
            <Link to={`/property/${id}/habu`} className="flex items-center gap-2 text-small text-black/60 dark:text-white/60 hover:text-black dark:hover:text-white mb-4 transition-colors">
            ...
            <div className="flex items-start justify-between">
              <div>
                ...
                <p className="text-small text-black/50 dark:text-white/50 max-w-2xl">
        ...
        <div className="max-w-5xl mx-auto px-6 py-2.5">
          {/* Partner Card */}
          <div className="bg-white dark:bg-[#0a0a0a] border border-black/5 dark:border-white/10 rounded-lg overflow-hidden mb-6">
            <div className="p-12">
              <div className="flex items-start gap-8">
                ...
                <div className="flex-1">
                  ...
                  <div className="grid grid-cols-3 gap-4 mt-8">
                    <div className="bg-black/[0.02] dark:bg-white/[0.02] border border-black/5 dark:border-white/10 rounded-lg p-5">
                      <div className="flex items-center gap-2 mb-2">
                        <Award className="w-4 h-4 text-blue-400" />
                        <div className="text-caption text-black/40 dark:text-white/40 tracking-wide uppercase">Projects Led</div>
                      </div>
                      <div className="text-h2 tracking-tight text-black dark:text-white/95">42</div>
                    </div>

                    <div className="bg-black/[0.02] dark:bg-white/[0.02] border border-black/5 dark:border-white/10 rounded-lg p-5">
                      <div className="flex items-center gap-2 mb-2">
                        <User className="w-4 h-4 text-blue-400" />
                        <div className="text-caption text-black/40 dark:text-white/40 tracking-wide uppercase">Client Rating</div>
                      </div>
                      <div className="text-h2 tracking-tight text-black dark:text-white/95">4.9/5</div>
                    </div>

                    <div className="bg-black/[0.02] dark:bg-white/[0.02] border border-black/5 dark:border-white/10 rounded-lg p-5">
                      <div className="flex items-center gap-2 mb-2">
                        <CheckCircle2 className="w-4 h-4 text-blue-400" />
                        <div className="text-caption text-black/40 dark:text-white/40 tracking-wide uppercase">Success Rate</div>
                      </div>
                      <div className="text-h2 tracking-tight text-black dark:text-white/95">96%</div>
                    </div>
                  </div>
                </div>
              </div>
            ...
            {/* SLA Information */}
            <div className="border-t border-black/5 dark:border-white/10 bg-black/[0.02] dark:bg-white/[0.02] p-4 md:p-5 lg:p-6">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="text-small text-black dark:text-white mb-1">Service Level Agreement</div>
          ...
          {/* Why This Match */}
          <div className="bg-white dark:bg-[#0a0a0a] border border-black/5 dark:border-white/10 rounded-lg p-10 mb-6">
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <div className="text-small text-black dark:text-white mb-1">Relevant Expertise</div>
              ...
              <div className="flex items-start gap-3">
                <CheckCircle2 className="w-5 h-5 text-emerald-400 mt-0.5 flex-shrink-0" />
                <div>
                  <div className="text-small text-black dark:text-white mb-1">Geographic Knowledge</div>
                  <div className="text-small text-black/60 dark:text-white/60">
              ...
              <div className="flex items-start gap-3">
                <CheckCircle2 className="w-5 h-5 text-emerald-400 mt-0.5 flex-shrink-0" />
                <div>
                  <div className="text-small text-black dark:text-white mb-1">Track Record</div>
                  <div className="text-small text-black/60 dark:text-white/60">
              ...
              <div className="flex items-start gap-3">
                <CheckCircle2 className="w-5 h-5 text-emerald-400 mt-0.5 flex-shrink-0" />
                <div>
                  <div className="text-small text-black dark:text-white mb-1">Network Access</div>
                  <div className="text-small text-black/60 dark:text-white/60">
          ...
          <div className="flex items-center gap-4">
            <Link
              ...
              className="flex-1 inline-flex items-center justify-center gap-2 bg-black dark:bg-white text-white dark:text-black px-6 py-2.5 rounded-md hover:bg-black/90 dark:hover:bg-white/90 transition-colors text-small tracking-wide"
            >
              Accept & Begin Execution
              <ArrowRight className="w-4 h-4" />
            </Link>
            <button className="flex-1 inline-flex items-center justify-center gap-2 bg-black/5 dark:bg-white/5 text-black/95 dark:text-white/95 px-6 py-2.5 rounded-md hover:bg-black/10 dark:hover:bg-white/10 transition-colors text-small tracking-wide border border-black/10 dark:border-white/10">
