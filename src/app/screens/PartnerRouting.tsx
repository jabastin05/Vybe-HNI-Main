...
export function PartnerRouting() {
 ...
 <div>
 <div className="text-caption font-normal tracking-[0.05em] uppercase text-gray-400 dark:text-white/50 mb-2">
 Expert Assignment
 </div>
 <div className="text-h1 font-normal tracking-tight text-gray-900 dark:text-white mb-2">
 Your Expert
 </div>
 ...
 <div>
 <h2 className="text-body font-normal tracking-tight text-gray-900 dark:text-white mb-2">
 {mockPartner.name}
 </h2>
 <p className="text-small font-normal text-gray-600 dark:text-white/50 mb-1">
 {mockPartner.role}
 </p>
 ...
 <div className="bg-emerald-500/10 text-emerald-400 px-6 py-2.5 rounded-md text-caption font-normal tracking-wide border border-emerald-500/20">
 Verified Expert
 </div>
 </div>
 ...
 <div className="text-caption font-normal text-gray-400 dark:text-white/40 tracking-wide uppercase">Projects Led</div>
 </div>
 <div className="text-h2 font-normal tracking-tight text-gray-900 dark:text-white/95">42</div>
 </div>

 <div className="bg-brand-navy/[0.02] dark:bg-white/[0.02] shadow-card rounded-lg p-5">
 <div className="flex items-center gap-2 mb-2">
 <User className="w-4 h-4 text-blue-400" />
 <div className="text-caption font-normal text-gray-400 dark:text-white/40 tracking-wide uppercase">Client Rating</div>
 </div>
 <div className="text-h2 font-normal tracking-tight text-gray-900 dark:text-white/95">4.9/5</div>
 </div>

 <div className="bg-brand-navy/[0.02] dark:bg-white/[0.02] shadow-card rounded-lg p-5">
 <div className="flex items-center gap-2 mb-2">
 <CheckCircle2 className="w-4 h-4 text-blue-400" />
 <div className="text-caption font-normal text-gray-400 dark:text-white/40 tracking-wide uppercase">Success Rate</div>
 </div>
 <div className="text-h2 font-normal tracking-tight text-gray-900 dark:text-white/95">96%</div>
 </div>
 </div>
 </div>
 </div>
 ...
 <div>
 <div className="text-small font-normal text-gray-900 dark:text-white mb-1">Service Level Agreement</div>
 ...
 <h3 className="text-caption font-normal tracking-[0.05em] uppercase text-gray-400 dark:text-white/50 mb-6">
 Why This Match?
 </h3>
 ...
 <div>
 <div className="text-small font-normal text-gray-900 dark:text-white mb-1">Relevant Expertise</div>
 ...
 <CheckCircle2 className="w-5 h-5 text-emerald-400 mt-0.5 flex-shrink-0" />
 <div>
 <div className="text-small font-normal text-gray-900 dark:text-white mb-1">Geographic Knowledge</div>
 <div className="text-small text-gray-600 dark:text-white/50">
 ...
 <CheckCircle2 className="w-5 h-5 text-emerald-400 mt-0.5 flex-shrink-0" />
 <div>
 <div className="text-small font-normal text-gray-900 dark:text-white mb-1">Track Record</div>
 <div className="text-small text-gray-600 dark:text-white/50">
 ...
 <CheckCircle2 className="w-5 h-5 text-emerald-400 mt-0.5 flex-shrink-0" />
 <div>
 <div className="text-small font-normal text-gray-900 dark:text-white mb-1">Network Access</div>
 <div className="text-small text-gray-600 dark:text-white/50">
 ...
 className="flex-1 inline-flex items-center justify-center gap-2 bg-brand-navy dark:bg-white text-white dark:text-gray-900 px-6 py-2.5 rounded-md hover:bg-brand-navy/90 dark:hover:bg-white/90 transition-colors text-small font-normal tracking-wide"
 >
 Accept & Begin Execution
 <ArrowRight className="w-4 h-4" />
 </Link>
 <button className="flex-1 inline-flex items-center justify-center gap-2 bg-brand-navy/5 dark:bg-white/5 text-gray-900/95 dark:text-white/95 px-6 py-2.5 rounded-md hover:bg-brand-navy/10 dark:hover:bg-white/10 transition-colors text-small font-normal tracking-wide shadow-card">
