...
export function Landing() {
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] dark:bg-[#0a0a0a] text-slate-900 font-sans selection:bg-emerald-500/30">
            ...
            <div className="w-full lg:w-3/5 p-4 md:p-5 lg:p-6 md:p-12 flex items-center justify-center bg-[#F8FAFC] dark:bg-[#0a0a0a]">
              <AnimatePresence mode="wait">
                <motion.div
                  ...
                  className="w-full h-full relative rounded-xl overflow-hidden shadow-2xl max-h-[500px]"
                >
                  <img 
      ...
      <section className="py-24 px-6 bg-[#F8FAFC] dark:bg-[#0a0a0a] relative">
        <div className="max-w-[1200px] mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-3xl mx-auto">
            ...
            <motion.div 
              whileHover={{ y: -5 }}
              className="bg-[#42D2B7] p-4 md:p-5 lg:p-6 rounded-xl text-white relative cursor-pointer shadow-lg shadow-[#42D2B7]/20 flex flex-col h-full"
            >
            ...
            <motion.div 
              whileHover={{ y: -5 }}
              className="bg-[#479E8E] p-4 md:p-5 lg:p-6 rounded-xl text-white relative cursor-pointer shadow-lg shadow-[#479E8E]/20 flex flex-col h-full"
            >
              <div className="flex justify-between items-start mb-6">
      ...
      {/* Lifecycle Section */}
      <section id="how-it-works" className="py-32 px-6 dark:bg-[#0a0a0a] text-white relative overflow-hidden">
        <div className="absolute inset-0 opacity-20">
          <img src={imgContainer} alt="Cityscape background" className="w-full h-full object-cover" />
          <div className="absolute inset-0 dark:bg-[#0a0a0a]/80" />
        </div>
