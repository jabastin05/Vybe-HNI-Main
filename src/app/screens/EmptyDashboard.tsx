...
${firstName}` : "Welcome"}
 ...
 <div key={i} className="flex items-center gap-4 bg-white dark:bg-card border border-gray-100 dark:border-white/[0.06] rounded-2xl px-4 py-4 opacity-60">
 ...
 <div className="bg-white dark:bg-card shadow-card rounded-2xl p-10 md:p-14 text-center mb-8 relative overflow-hidden">
 ...
 {capabilities.map((f, i) => (
 <div key={i} className="bg-white dark:bg-card shadow-card rounded-2xl p-5 md:p-7 text-center opacity-55 relative overflow-hidden">
 <div className="absolute top-3.5 right-3.5 w-6 h-6 rounded-full bg-gray-100 dark:bg-white/10 flex items-center justify-center">
 <svg className="w-3 h-3 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}><rect x="5" y="11" width="14" height="10" rx="2" /><path d="M7 11V7a5 5 0 0 1 10 0v4" /></svg>
 </div>
