...
export function NotFound() {
 ...
 <div className="text-[72px] font-normal text-gray-900/10 dark:text-white/10 mb-4">
 404
 </div>
 <h1 className="text-h1 font-normal text-gray-900 dark:text-white mb-3">
 Page Not Found
 </h1>
 ...
 <button
 onClick={() => navigate(-1)}
 className="w-full px-6 py-2.5 rounded-xl bg-white dark:bg-white/[0.04] text-gray-600 dark:text-white/50 text-small font-normal hover:bg-gray-100 dark:hover:bg-white/10 transition-all flex items-center justify-center gap-2"
 >
