...
export function NotFound() {
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] dark:bg-[#0a0a0a] flex items-center justify-center px-8">
      <div className="max-w-md w-full text-center">
        <div className="bg-white dark:bg-[#0d1b2e] rounded-xl p-12 border border-[#E2E8F0] dark:border-white/[0.08] shadow-lg">
          ...
          <div className="flex flex-col gap-3">
            <button
              ...
              className="w-full px-6 py-2.5 rounded-xl bg-[#0B1F3A] dark:bg-[#0d1b2e] text-white text-small font-normal hover:bg-[#0f2a50] dark:hover:bg-[#162d52] transition-all flex items-center justify-center gap-2"
            >
